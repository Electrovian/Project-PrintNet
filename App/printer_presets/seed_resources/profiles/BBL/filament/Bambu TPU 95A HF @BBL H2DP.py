...
# source: profiles/BBL/filament/Bambu TPU 95A HF @BBL H2DP.json
DATA = {'additional_cooling_fan_speed': ['100'],
 ...
 'filament_ramming_volumetric_speed': ['3.0', '3.0'],
