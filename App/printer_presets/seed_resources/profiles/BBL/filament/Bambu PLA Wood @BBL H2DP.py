...
# source: profiles/BBL/filament/Bambu PLA Wood @BBL H2DP.json
DATA = {'compatible_printers': ['Bambu Lab H2D Pro 0.4 nozzle', 'Bambu Lab H2D Pro 0.6 nozzle'],
 'eng_plate_temp': ['55'],
