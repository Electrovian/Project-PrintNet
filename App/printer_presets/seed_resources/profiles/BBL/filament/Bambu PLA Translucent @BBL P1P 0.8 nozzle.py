...
# source: profiles/BBL/filament/Bambu PLA Translucent @BBL P1P 0.8 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab P1P 0.6 nozzle', 'Bambu Lab P1P 0.8 nozzle'],
