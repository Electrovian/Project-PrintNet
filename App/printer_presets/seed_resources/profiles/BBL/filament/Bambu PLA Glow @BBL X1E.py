...
# source: profiles/BBL/filament/Bambu PLA Glow @BBL X1E.json
DATA = {'compatible_printers': ['Bambu Lab X1E 0.4 nozzle', 'Bambu Lab X1E 0.6 nozzle', 'Bambu Lab X1E 0.8 nozzle'],
