...
# source: profiles/BBL/filament/Bambu PLA Translucent @BBL H2S.json
DATA = {'additional_cooling_fan_speed': ['75'],
 'compatible_printers': ['Bambu Lab H2S 0.4 nozzle', 'Bambu Lab H2S 0.6 nozzle', 'Bambu Lab H2S 0.8 nozzle'],
 'description': 'The generic presets are conservatively tuned for compatibility with a wider range of filaments. For '
