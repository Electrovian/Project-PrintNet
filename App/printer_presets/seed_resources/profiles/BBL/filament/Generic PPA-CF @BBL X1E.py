...
# source: profiles/BBL/filament/Generic PPA-CF @BBL X1E.json
DATA = {'chamber_temperatures': ['60'],
 'compatible_printers': ['Bambu Lab X1E 0.4 nozzle', 'Bambu Lab X1E 0.6 nozzle', 'Bambu Lab X1E 0.8 nozzle'],
 'fan_max_speed': ['35'],
