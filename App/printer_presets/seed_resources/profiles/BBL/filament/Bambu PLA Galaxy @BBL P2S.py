...
# source: profiles/BBL/filament/Bambu PLA Galaxy @BBL P2S.json
DATA = {'additional_cooling_fan_speed': ['100'],
 'compatible_printers': ['Bambu Lab P2S 0.4 nozzle', 'Bambu Lab P2S 0.6 nozzle'],
 'eng_plate_temp': ['55'],
