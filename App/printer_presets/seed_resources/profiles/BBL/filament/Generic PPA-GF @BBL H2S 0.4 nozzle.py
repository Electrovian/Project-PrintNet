...
# source: profiles/BBL/filament/Generic PPA-GF @BBL H2S 0.4 nozzle.json
DATA = {'chamber_temperatures': ['60'],
 'compatible_printers': ['Bambu Lab H2S 0.6 nozzle', 'Bambu Lab H2S 0.8 nozzle', 'Bambu Lab H2S 0.4 nozzle'],
