...
# source: profiles/BBL/filament/Generic PPS @BBL H2S 0.4 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab H2S 0.6 nozzle', 'Bambu Lab H2S 0.8 nozzle', 'Bambu Lab H2S 0.4 nozzle'],
