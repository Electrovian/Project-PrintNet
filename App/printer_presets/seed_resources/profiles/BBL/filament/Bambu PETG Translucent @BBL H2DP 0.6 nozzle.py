...
# source: profiles/BBL/filament/Bambu PETG Translucent @BBL H2DP 0.6 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab H2D Pro 0.6 nozzle', 'Bambu Lab H2D Pro 0.8 nozzle'],
 'fan_max_speed': ['60'],
 'fan_min_speed': ['20'],
