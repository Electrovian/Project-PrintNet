...
# source: profiles/BBL/filament/Bambu PLA Translucent @BBL A1 0.8 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab A1 0.6 nozzle', 'Bambu Lab A1 0.8 nozzle'],
