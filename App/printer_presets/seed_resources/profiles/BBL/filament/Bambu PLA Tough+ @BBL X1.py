...
# source: profiles/BBL/filament/Bambu PLA Tough+ @BBL X1.json
DATA = {'additional_cooling_fan_speed': ['70'],
 'compatible_printers': ['Bambu Lab X1 0.4 nozzle', 'Bambu Lab X1 0.6 nozzle', 'Bambu Lab X1 0.8 nozzle'],
