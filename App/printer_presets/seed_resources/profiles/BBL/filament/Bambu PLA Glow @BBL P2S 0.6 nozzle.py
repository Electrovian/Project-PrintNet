...
# source: profiles/BBL/filament/Bambu PLA Glow @BBL P2S 0.6 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab P2S 0.6 nozzle'],
 'eng_plate_temp': ['55'],
