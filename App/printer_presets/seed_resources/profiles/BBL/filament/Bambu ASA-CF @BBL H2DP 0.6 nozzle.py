...
# source: profiles/BBL/filament/Bambu ASA-CF @BBL H2DP 0.6 nozzle.json
DATA = {'chamber_temperatures': ['60'],
 'compatible_printers': ['Bambu Lab H2D Pro 0.6 nozzle', 'Bambu Lab H2D Pro 0.8 nozzle'],
