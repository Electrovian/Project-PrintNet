...
# source: profiles/BBL/filament/Bambu PLA Matte @BBL H2DP.json
DATA = {'additional_cooling_fan_speed': ['75'],
 'compatible_printers': ['Bambu Lab H2D Pro 0.4 nozzle', 'Bambu Lab H2D Pro 0.6 nozzle'],
 'counter_coef_2': ['0.06'],
 'counter_coef_3': ['-0.32'],
 'counter_limit_max': ['0.05'],
 'counter_limit_min': ['-0.4'],
 'eng_plate_temp': ['55'],
