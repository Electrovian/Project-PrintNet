...
# source: profiles/BBL/filament/Bambu PLA Glow @BBL P1P.json
DATA = {'compatible_printers': ['Bambu Lab P1P 0.6 nozzle', 'Bambu Lab P1P 0.4 nozzle', 'Bambu Lab P1P 0.8 nozzle'],
