...
# source: profiles/BBL/filament/Bambu PC @BBL P2S 0.6 nozzle.json
DATA = {'chamber_temperatures': ['60'],
 ...
 'filament_max_volumetric_speed': ['18', '35'],
 ...
 'filament_retraction_speed': ['40', '40'],
