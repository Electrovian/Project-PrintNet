...
# source: profiles/BBL/filament/Bambu PLA Dynamic @BBL P2S.json
DATA = {'compatible_printers': ['Bambu Lab P2S 0.4 nozzle', 'Bambu Lab P2S 0.6 nozzle'],
 'eng_plate_temp': ['55'],
