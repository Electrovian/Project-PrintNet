...
# source: profiles/BBL/filament/Bambu ABS @BBL X1C 0.8 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab X1 Carbon 0.8 nozzle', 'Bambu Lab X1 0.8 nozzle', 'Bambu Lab P1S 0.8 nozzle'],
 'fan_max_speed': ['60'],
