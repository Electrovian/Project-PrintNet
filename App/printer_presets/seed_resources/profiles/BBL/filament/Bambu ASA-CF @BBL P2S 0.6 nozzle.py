...
# source: profiles/BBL/filament/Bambu ASA-CF @BBL P2S 0.6 nozzle.json
DATA = {'activate_air_filtration': ['0'],
 'chamber_temperatures': ['60'],
 'compatible_printers': ['Bambu Lab P2S 0.6 nozzle', 'Bambu Lab P2S 0.8 nozzle'],
 'eng_plate_temp': ['90'],
