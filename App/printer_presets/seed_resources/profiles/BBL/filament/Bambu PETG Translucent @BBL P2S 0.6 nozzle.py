...
# source: profiles/BBL/filament/Bambu PETG Translucent @BBL P2S 0.6 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab P2S 0.6 nozzle', 'Bambu Lab P2S 0.8 nozzle'],
 'fan_max_speed': ['60'],
 'fan_min_speed': ['20'],
 ...
 'filament_retraction_length': ['0.2', '0.2'],
