...
# source: profiles/BBL/filament/Bambu PETG-CF @BBL H2DP 0.4 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab H2D Pro 0.4 nozzle'],
 'counter_coef_2': ['0.00565'],
 'counter_coef_3': ['-0.0112'],
 'counter_limit_max': ['0.065'],
