...
# source: profiles/BBL/filament/P1P/Bambu PLA Tough+ @BBL P1P.json
DATA = {'additional_cooling_fan_speed': ['70'],
 'compatible_printers': ['Bambu Lab P1P 0.4 nozzle', 'Bambu Lab P1P 0.6 nozzle', 'Bambu Lab P1P 0.8 nozzle'],
