...
# source: profiles/BBL/filament/SUNLU/SUNLU Wood PLA @BBL P1P.json
DATA = {'compatible_printers': ['Bambu Lab P1P 0.4 nozzle', 'Bambu Lab P1P 0.6 nozzle', 'Bambu Lab P1P 0.8 nozzle'],
 ...
 'filament_deretraction_speed': ['0', '0'],
 ...
 'filament_retraction_length': ['4', '4'],
 'filament_retraction_minimum_travel': ['nil', 'nil'],
 'filament_retraction_speed': ['50', '50'],
