...
# source: profiles/BBL/filament/Generic PC @BBL P1S.json
DATA = {'compatible_printers': ['Bambu Lab P1S 0.4 nozzle', 'Bambu Lab P1S 0.6 nozzle', 'Bambu Lab P1S 0.8 nozzle'],
 'eng_plate_temp': ['100'],
