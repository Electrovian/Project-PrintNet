...
# source: profiles/BBL/filament/Bambu PLA Lite @BBL P2S 0.4 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab P2S 0.4 nozzle'],
 'eng_plate_temp': ['55'],
 ...
 'filament_max_volumetric_speed': ['16', '40'],
 ...
 'filament_retraction_distances_when_cut': ['10', '18'],
