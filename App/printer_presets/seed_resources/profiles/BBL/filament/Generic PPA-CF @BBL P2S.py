...
# source: profiles/BBL/filament/Generic PPA-CF @BBL P2S.json
DATA = {'chamber_temperatures': ['60'],
 'compatible_printers': ['Bambu Lab P2S 0.4 nozzle', 'Bambu Lab P2S 0.6 nozzle', 'Bambu Lab P2S 0.8 nozzle'],
 'fan_max_speed': ['35'],
