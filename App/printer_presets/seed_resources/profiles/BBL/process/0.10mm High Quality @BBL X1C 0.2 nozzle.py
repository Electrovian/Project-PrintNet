...
# source: profiles/BBL/process/0.10mm High Quality @BBL X1C 0.2 nozzle.json
DATA = {'bridge_speed': ['50', '50'],
 'compatible_printers': ['Bambu Lab X1 Carbon 0.2 nozzle',
 ...
 'initial_layer_infill_speed': ['70', '70'],
