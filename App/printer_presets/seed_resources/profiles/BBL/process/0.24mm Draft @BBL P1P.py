...
# source: profiles/BBL/process/0.24mm Draft @BBL P1P.json
DATA = {'bridge_speed': ['50', '50'],
 ...
 'inner_wall_speed': ['230', '230'],
 'instantiation': 'true',
 'internal_solid_infill_speed': ['230', '230'],
