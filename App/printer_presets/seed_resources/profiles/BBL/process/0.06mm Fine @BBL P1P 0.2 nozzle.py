...
# source: profiles/BBL/process/0.06mm Fine @BBL P1P 0.2 nozzle.json
DATA = {'bridge_speed': ['50', '50'],
 'compatible_printers': ['Bambu Lab P1P 0.2 nozzle'],
 'default_acceleration': ['5000', '5000'],
 'description': 'Compared with the default profile of 0.2 mm nozzle, it has a smaller layer height, and results in '
