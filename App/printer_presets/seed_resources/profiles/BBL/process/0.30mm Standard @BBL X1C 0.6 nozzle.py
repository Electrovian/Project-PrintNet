...
# source: profiles/BBL/process/0.30mm Standard @BBL X1C 0.6 nozzle.json
DATA = {'bridge_speed': ['30', '30'],
 'compatible_printers': ['Bambu Lab X1 Carbon 0.6 nozzle', 'Bambu Lab P1S 0.6 nozzle', 'Bambu Lab X1E 0.6 nozzle'],
