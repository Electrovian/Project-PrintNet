...
# source: profiles/BBL/process/0.12mm Draft @BBL A1M 0.2 nozzle.json
DATA = {'compatible_printers': ['Bambu Lab A1 mini 0.2 nozzle'],
 'default_acceleration': ['6000'],
 'description': 'Compared with the default profile of a 0.2 mm nozzle, it has a slightly bigger layer height, and '
