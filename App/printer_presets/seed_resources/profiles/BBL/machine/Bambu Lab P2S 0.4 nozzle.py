...
# source: profiles/BBL/machine/Bambu Lab P2S 0.4 nozzle.json
DATA = {'bed_exclude_area': [],
 'change_filament_gcode': ';======== P2S filament_change gcode ==========\n'
                          ...
                          'M204 S9000\n'
                          '{if toolchange_count > 1 && (z_hop_types[current_extruder] == 0 || '
                          'z_hop_types[current_extruder] == 3)}\n'
                          'G17\n'
                          'G2 Z{z_after_toolchange + 0.4} I0.86 J0.86 P1 F10000 ; spiral lift a little from second '
                          'lift\n'
                          '{endif}\n'
                          '\n'
                          ';nozzle_change_gcode\n'
                          ...
                          'M620.11 P1 L0 I[current_extruder] E-{retraction_distance_when_cut} '
                          ...
                          '    M106 P2 S{first_x_layer_fan_speed[next_extruder]*255.0/100.0 };set first x_layer aux '
                          'fan\n'
                          '    M106 P10 S{first_x_layer_fan_speed[next_extruder]*255.0/100.0 };set first x_layer left '
                          'aux fan        \n'
                          '{else}\n'
                          '    {if (min_vitrification_temperature <= 50)}\n'
                          '        {if (nozzle_diameter == 0.2)}\n'
                          '            M142 P1 R30 S40 U{max_additional_fan/100.0} V1.0 O45; set PLA/TPU ND0.2 chamber '
                          'autocooling\n'
                          '        {else}\n'
                          '            M142 P1 R30 S40 U{max_additional_fan/100.0} V1.0 O45; set PLA/TPU ND0.4 chamber '
                          'autocooling\n'
                          '        {endif}\n'
                          '    {else}\n'
                          '        {if (nozzle_diameter == 0.2)}\n'
                          '            M142 P1 R45 S50 U{max_additional_fan/100.0} V0.5 O50; set PETG ND0.2 chamber '
                          'autocooling\n'
                          '        {else}\n'
                          '            M142 P1 R50 S55 U{max_additional_fan/100.0} V0.5 O55; set PETG ND0.4 chamber '
                          'autocooling\n'
                          '        {endif}\n'
                          '    {endif}\n'
                          '        M106 P10 S{additional_cooling_fan_speed[next_extruder]*255.0/100.0};set left aux '
                          'fan \n'
                          '{endif}\n'
                          '{endif}\n'
 ...
 'deretract_speed_extruder_change': ['30', '30'],
 ...
 'machine_max_speed_x': ['600', '600', '600', '600'],
 'machine_max_speed_y': ['600', '600', '600', '600'],
 ...
 'machine_start_gcode': ';M1002 set_flag extrude_cali_flag=1\n'
                        ...
                        '      G29 H\n'
                        '    {else}\n'
                        '      G29 A2 X{first_layer_print_min[0]} Y{first_layer_print_min[1]} '
                        'I{first_layer_print_size[0]} J{first_layer_print_size[1]}\n'
                        '    {endif}\n'
                        '    M400\n'
                        '    M500 ; save cali data\n'
                        ...
                        '  G130 O0 X100 Y-0.5 Z0.8 '
                        'F{filament_max_volumetric_speed[initial_no_support_extruder]/2/2.4053} L40 E20 D5\n'
                        '  G90\n'
                        '  M83\n'
                        '  G1 Z0.2\n'
                        '  M400\n'
                        ...
                        '(filament_type[initial_no_support_extruder] == "PLA") ||  '
                        '(filament_type[initial_no_support_extruder] == "PETG")}\n'
 ...
 'nozzle_diameter': ['0.4'],
 'nozzle_flush_dataset': ['0', '0'],
 'nozzle_height': '4.2',
 'nozzle_type': ['hardened_steel', 'hardened_steel'],
 'nozzle_volume': ['110', '110'],
 ...
 'time_lapse_gcode': ';======== P2S timeslape gcode ==========\n'
                     ...
                     '; SKIPPABLE_END\n',
 'type': 'machine',
 'upward_compatible_machine': ['Bambu Lab A1 0.4 nozzle',
