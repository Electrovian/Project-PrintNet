...
# source: profiles/BBL/machine/Bambu Lab H2D Pro 0.4 nozzle.json
DATA = {'change_filament_gcode': ';======== H2D Pro filament ========\n'
                          ';===== 20250725 =====\n'
                          'M993 A2 B2 C2 ; nozzle cam detection allow status save.\n'
                          'M993 A0 B0 C0 ; nozzle cam detection not allowed.\n'
                          '\n'
                          '{if (filament_type[next_extruder] == "PLA") ||  (filament_type[next_extruder] == "PETG")\n'
                          ' ||  (filament_type[next_extruder] == "PLA-CF")  ||  (filament_type[next_extruder] == '
                          '"PETG-CF")}\n'
                          ...
                          '{endif}\n'
                          '\n'
                          '{if ((filament_type[current_extruder] == "PLA") || (filament_type[current_extruder] == '
                          '"PLA-CF") || (filament_type[current_extruder] == "PETG")) && '
                          '(nozzle_diameter[current_extruder] == 0.2)}\n'
                          'M620.10 A0 F74.8347 L[flush_length] H{nozzle_diameter[current_extruder]} '
                          'T{flush_temperatures[current_extruder]} P{nozzle_temperature[current_extruder]} S1\n'
                          '{else}\n'
                          'M620.10 A0 F{flush_volumetric_speeds[current_extruder]/2.4053*60} L[flush_length] '
                          'H{nozzle_diameter[current_extruder]} T{flush_temperatures[current_extruder]} '
                          'P{nozzle_temperature[current_extruder]} S1\n'
                          '{endif}\n'
                          '\n'
                          '{if ((filament_type[next_extruder] == "PLA") || (filament_type[next_extruder] == "PLA-CF") '
                          '|| (filament_type[next_extruder] == "PETG")) && (nozzle_diameter[next_extruder] == 0.2)}\n'
                          'M620.10 A1 F74.8347 L[flush_length] H{nozzle_diameter[next_extruder]} '
                          'T{flush_temperatures[next_extruder]} P{nozzle_temperature[next_extruder]} S1\n'
                          '{else}\n'
                          'M620.10 A1 F{flush_volumetric_speeds[next_extruder]/2.4053*60} L[flush_length] '
                          'H{nozzle_diameter[next_extruder]} T{flush_temperatures[next_extruder]} '
                          'P{nozzle_temperature[next_extruder]} S1\n'
                          '{endif}\n'
                          '\n'
                          '{if long_retraction_when_cut}\n'
                          'M620.11 P1 I[current_extruder] E-{retraction_distance_when_cut} '
                          'F{max((flush_volumetric_speeds[current_extruder]/2.4053*60), 200)}\n'
                          '{else}\n'
                          'M620.11 P0 I[current_extruder] E0\n'
                          '{endif}\n'
                          '\n'
                          '{if long_retraction_when_ec}\n'
                          'M620.11 K1 I[current_extruder] R{retraction_distance_when_ec} '
                          'F{max((flush_volumetric_speeds[current_extruder]/2.4053*60), 200)}\n'
                          '{else}\n'
                          ...
                          'M620.11 S0 L0 I[current_extruder] E-{retraction_distances_when_cut[current_extruder]} '
                          'F{max((flush_volumetric_speeds[current_extruder]/2.4053*60), 200)}\n'
                          '{else}\n'
                          '{if (filament_type[current_extruder] == "PA") || (filament_type[current_extruder] == '
                          '"PA-GF")}\n'
                          'M620.11 S1 L0 I[current_extruder] R4 D2 E-{retraction_distances_when_cut[current_extruder]} '
                          'F{max((flush_volumetric_speeds[current_extruder]/2.4053*60), 200)}\n'
                          '{else}\n'
                          'M620.11 S1 L0 I[current_extruder] R10 D8 '
                          'E-{retraction_distances_when_cut[current_extruder]} '
                          'F{max((flush_volumetric_speeds[current_extruder]/2.4053*60), 200)}\n'
                          '{endif}\n'
                          '{endif}\n'
                          'M629\n'
                          ...
                          'R{retract_length_toolchange[filament_map[next_extruder]-1]}\n'
                          '\n'
                          'M400\n'
 ...
 'default_filament_profile': ['Bambu PLA Basic @BBL H2DP'],
 'default_print_profile': '0.20mm Standard @BBL H2DP',
 ...
 'from': 'system',
 'hotend_heating_rate': ['3.6', '3.6', '3.6', '3.6'],
 ...
 'machine_max_speed_e': ['50', '50', '50', '50', '50', '50', '50', '50'],
 'machine_max_speed_x': ['1000', '1000', '1000', '1000', '1000', '1000', '1000', '1000'],
 'machine_max_speed_y': ['1000', '1000', '1000', '1000', '1000', '1000', '1000', '1000'],
 'machine_max_speed_z': ['30', '30', '30', '30', '30', '30', '30', '30'],
 'machine_start_gcode': ';===== machine: H2D Pro start ======\n'
                        ...
                        '            M142 P1 R35 S40 T45 U0.3 V0.5 W0.8 O45 L1 ; set third-party PETG chamber '
                        'autocooling\n'
                        '        {else}\n'
                        '            {if (nozzle_diameter == 0.2)}\n'
                        '                M142 P1 R35 S45 T50 U0.3 V0.5 W0.8 O50 L1 ; set PETG ND0.2 chamber '
                        'autocooling\n'
                        '            {else}\n'
                        ...
                        '    \n'
                        '    M104 S{nozzle_temperature_initial_layer[initial_no_support_extruder]-80} A ; rise temp in '
                        'advance\n'
                        '\n'
                        ...
                        '(nozzle_diameter[initial_no_support_extruder] == 0.2)}\n'
                        'M620.10 A0 F74.8347 H{nozzle_diameter[initial_no_support_extruder]} '
                        'T{flush_temperatures[initial_no_support_extruder]} '
                        'P{nozzle_temperature_initial_layer[initial_no_support_extruder]} S1\n'
                        'M620.10 A1 F74.8347 H{nozzle_diameter[initial_no_support_extruder]} '
                        'T{flush_temperatures[initial_no_support_extruder]} '
                        'P{nozzle_temperature_initial_layer[initial_no_support_extruder]} S1\n'
                        '{else}\n'
                        'M620.10 A0 F{flush_volumetric_speeds[initial_no_support_extruder]/2.4053*60} '
                        'H{nozzle_diameter[initial_no_support_extruder]} '
                        'T{flush_temperatures[initial_no_support_extruder]} '
                        'P{nozzle_temperature_initial_layer[initial_no_support_extruder]} S1\n'
                        'M620.10 A1 F{flush_volumetric_speeds[initial_no_support_extruder]/2.4053*60} '
                        'H{nozzle_diameter[initial_no_support_extruder]} '
                        'T{flush_temperatures[initial_no_support_extruder]} '
                        'P{nozzle_temperature_initial_layer[initial_no_support_extruder]} S1\n'
                        '{endif}\n'
                        ...
                        '\n'
                        '{if long_retraction_when_ec }\n'
                        'M620.11 K1 I[initial_no_support_extruder] R{retraction_distance_when_ec} '
                        'F{max((flush_volumetric_speeds[initial_no_support_extruder]/2.4053*60), 200)}\n'
                        '{else}\n'
                        ...
                        '    M620.11 S0 L0 I[initial_no_support_extruder] '
                        'E-{retraction_distances_when_cut[initial_no_support_extruder]} '
                        'F{flush_volumetric_speeds[initial_no_support_extruder]/2.4053*60}\n'
                        '{else}\n'
                        '{if (filament_type[initial_no_support_extruder] == "PA") ||  '
                        '(filament_type[initial_no_support_extruder] == "PA-GF")}\n'
                        '    M620.11 S1 L0 I[initial_no_support_extruder] R4 D2 '
                        'E-{retraction_distances_when_cut[initial_no_support_extruder]} '
                        'F{flush_volumetric_speeds[initial_no_support_extruder]/2.4053*60}\n'
                        '{else}\n'
                        '    M620.11 S1 L0 I[initial_no_support_extruder] R10 D8 '
                        'E-{retraction_distances_when_cut[initial_no_support_extruder]} '
                        'F{flush_volumetric_speeds[initial_no_support_extruder]/2.4053*60}\n'
                        '{endif}\n'
                        '{endif}\n'
                        ...
                        '\n'
                        'M622 J0\n'
                        '    M983.3 F{filament_max_volumetric_speed[initial_no_support_extruder]/2.4} A0.4 ; cali '
                        ...
                        '    G29.20 A3\n'
                        '    G29 A1 O X{first_layer_print_min[0]} Y{first_layer_print_min[1]} '
                        ...
                        '    {else}\n'
                        '        G29.20 A4\n'
                        '        G29 A2 O X{first_layer_print_min[0]} Y{first_layer_print_min[1]} '
                        'I{first_layer_print_size[0]} J{first_layer_print_size[1]}\n'
                        '    {endif}\n'
                        '    M400\n'
                        '    M500 ; save cali data\n'
                        ...
                        '    M141 S0\n'
                        '    M620.17 T0 S{nozzle_temperature_initial_layer[(first_non_support_filaments[0] != -1 ? '
                        'first_non_support_filaments[0] : first_filaments[0])]} L{(first_non_support_filaments[0] != '
                        '-1 ? first_non_support_filaments[0] : first_filaments[0])}\n'
                        '    M620.17 T1 S{nozzle_temperature_initial_layer[(first_non_support_filaments[1] != -1 ? '
                        'first_non_support_filaments[1] : first_filaments[1])]} L{(first_non_support_filaments[1] != '
                        '-1 ? first_non_support_filaments[1] : first_filaments[1])}\n'
                        '    G383 O1 T{nozzle_temperature_initial_layer[initial_no_support_extruder]} '
                        'L{initial_no_support_extruder}\n'
                        '    M500\n'
                        '    M141 S[overall_chamber_temperature]\n'
                        'M623\n'
                        '\n'
                        ...
                        'first_non_support_filaments[1] : first_filaments[1])]} L{(first_non_support_filaments[1] != '
                        '-1 ? first_non_support_filaments[1] : first_filaments[1])}\n'
                        '    G383.3 T{nozzle_temperature_initial_layer[initial_no_support_extruder]} '
                        'L{initial_no_support_extruder}\n'
                        '    M500\n'
                        '    M141 S[overall_chamber_temperature]\n'
                        'M623\n'
 ...
 'retraction_distances_when_cut': ['10', '10', '10', '10'],
 'setting_id': 'GM051',
 ...
 'time_lapse_gcode': ';======== H2D Pro 20250818========\n'
                     ...
                     '    M9711 M{timelapse_type} E{most_used_physical_extruder_id} X{timelapse_pos_x} '
                     'Y{timelapse_pos_y} Z{layer_z + 0.4} S11 C10 O0 T3000\n'
                     '{else}\n'
                     '    {if spiral_mode}\n'
                     '        M9711 M{timelapse_type} E{most_used_physical_extruder_id} Z{layer_z} S11 C10 O0 T3000\n'
                     '    {else}\n'
                     '        M9711 M{timelapse_type} E{most_used_physical_extruder_id} Z{layer_z + 0.4} S11 C10 O0 '
                     'T3000\n'
                     '    {endif}\n'
                     '{endif}\n'
                     '\n'
