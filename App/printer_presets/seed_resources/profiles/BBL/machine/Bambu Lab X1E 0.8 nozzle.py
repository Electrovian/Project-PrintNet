...
# source: profiles/BBL/machine/Bambu Lab X1E 0.8 nozzle.json
DATA = {'default_filament_profile': ['Bambu PLA Basic @BBL X1C 0.8 nozzle'],
 ...
 'instantiation': 'true',
 'machine_start_gcode': ';===== machine: X1E-0.8 =========================\n'
                        ';===== date: 20250909 =====================\n'
                        ';===== turn on the HB fan =================\n'
                        ...
                        '    M500 ; save cali data\n'
                        '\n'
                        '    M104 S{nozzle_temperature_initial_layer[initial_no_support_extruder]} ; rise nozzle temp '
                        'now ,to reduce temp waiting time.\n'
                        '\n'
                        '    T1100\n'
                        '    M400 P400\n'
                        '    M960 S0 P0\n'
                        ...
                        'D{outer_wall_volumetric_speed/(1.75*1.75/4*3.14)*60} E5.000 F175.000 H1.000 I0.000 J0.010 '
                        'K0.020\n'
                        '    M400 P100\n'
                        '    G0 F20000\n'
