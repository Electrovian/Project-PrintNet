...
# source: profiles/Raise3D/machine/Raise3D Pro3 Plus 0.4 nozzle (Dual).json
DATA = {'auxiliary_fan': '0',
 'before_layer_change_gcode': '; before layer [layer_num] change\n'
                              ...
                              'M140 S{max(bed_temperature_initial_layer_single, '
 ...
 'machine_start_gcode': ';Bounding Box: {digits(first_layer_print_min[0],0,2)} '
                        ...
                        'M190 S{max(bed_temperature_initial_layer_single, bed_temperature_initial_layer_single)} ; '
                        'wait for bed temp\n'
