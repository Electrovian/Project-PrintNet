...
MACHINE = {
  "machine/Ginger G1 1.2 nozzle.json": {
  ...
  "machine/Ginger G1 3.0 nozzle.json": {
    "inherits": "Ginger_G1_common",
    "instantiation": "true",
    "max_layer_height": [
      "2.5"
  ...
  "machine/Ginger G1 5.0 nozzle.json": {
    "inherits": "Ginger_G1_common",
    "instantiation": "true",
    "max_layer_height": [
      "3.5"
  ...
  "machine/Ginger G1 8.0 nozzle.json": {
    "inherits": "Ginger_G1_common",
    "instantiation": "true",
    "max_layer_height": [
      "5.0"
...
FILAMENT = {
  "filament/Ginger Generic PETG.json": {
  ...
  "filament/Ginger Generic PLA.json": {
    "close_fan_the_first_x_layers": [
      "4"
    ],
    "compatible_printers": [
