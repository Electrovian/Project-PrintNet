...
# source: profiles/iQ/filament/Grauts HPP4GF25 P1 @iQ TiQ2 0.4 Nozzle.json
DATA = {'activate_air_filtration': ['0'],
 ...
 'compatible_prints': ['0.20mm Standard @iQ TiQ2 P1 - HPP4GF25 Grauts (0.4 Nozzle)'],
 ...
 'filament_settings_id': ['Grauts HPP4GF25 P1 @iQ TiQ2 0.4 Nozzle'],
 'filament_shrink': ['98.994%'],
 'filament_shrinkage_compensation_z': ['99%'],
 'filament_soluble': ['0'],
