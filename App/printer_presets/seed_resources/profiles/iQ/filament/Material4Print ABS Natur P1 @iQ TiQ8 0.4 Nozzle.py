...
# source: profiles/iQ/filament/Material4Print ABS Natur P1 @iQ TiQ8 0.4 Nozzle.json
DATA = {'activate_air_filtration': ['0'],
 ...
 'chamber_temperature': ['75'],
 'close_fan_the_first_x_layers': ['1000'],
 'compatible_printers': ['iQ TiQ8 0.4 Nozzle'],
 'compatible_printers_condition': '',
 'compatible_prints': ['0.20mm Standard @iQ TiQ8 P1 - ABS Natur Material4Print (0.4 Nozzle)'],
 ...
 'filament_notes': ['Filament file version 1.0 20250620'],
 ...
 'filament_settings_id': ['Material4Print ABS Natur P1 @iQ TiQ8 0.4 Nozzle'],
 ...
 'filament_start_gcode': ['M109 S{nozzle_temperature_initial_layer[current_extruder]}\n'
 ...
 'filament_type': ['ABS Material4Print Natur'],
