...
# source: profiles/iQ/filament/Fiberthree PACF Pro P1 @iQ TiQ2 0.4 Nozzle.json
DATA = {'activate_air_filtration': ['0'],
 ...
 'compatible_prints': ['0.20mm Standard @iQ TiQ2 P1 - PACF Pro Fiberthree (0.4 Nozzle)'],
 ...
 'filament_settings_id': ['Fiberthree PACF Pro P1 @iQ TiQ2 0.4 Nozzle'],
 'filament_shrink': ['100%'],
