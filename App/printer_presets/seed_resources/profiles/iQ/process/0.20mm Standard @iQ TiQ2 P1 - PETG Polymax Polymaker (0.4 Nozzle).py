...
# source: profiles/iQ/process/0.20mm Standard @iQ TiQ2 P1 - PETG Polymax Polymaker (0.4 Nozzle).json
DATA = {'bottom_shell_layers': '4',
 ...
 'notes': 'Deutsch P1 Polymaker Polymax PETG Readme\n'
          '1.\tÜberprüfen Sie, dass sich das Polymaker Polymax PETG im linken Extruder befindet. Halten Sie das '
          'Filament trocken! Detailierte Trocknungsanleitung, siehe unten.\n'
          '2.\tÜberprüfen Sie, dass sich eine 0,4 mm Wolfram-Kupfer Düse im linken Extruder befindet.\n'
          '3.\tVerwenden Sie Magigoo Kleber auf der PET-Folie, um eine bessere Haftung zu gewährleisten. ( im '
          'Singledruck in der Regel auf PET-Folie nicht erforderlich)\n'
          ...
          'PETG-ESD ist hydrophil. Wenn Sie Stringing und Oozing an Ihrem Bauteil beobachten, ist dies ein Indiz '
          'dafür, dass das Filament zu feucht ist. Um das Filament zu trocknen, belassen Sie die Spule in einem '
          'industriellen Ofen bei 70°C für 8 Stunden.\n'
          '\n'
          'English P1 Polymaker Polymax PETG\n'
          '1.\tCheck Left extruder filament: Polymaker Polymax PETG - Keep the filament dry!! Detailed drying '
          'instruction below.\n'
          ...
          'PETG-ESD material is hydroscopic. If you feel you have stringing and oozing in your printed part, the '
          'filament have moisture in it.\n'
