...
# source: profiles/Geeetech/machine/Geeetech Mizar M 0.4 nozzle.json
DATA = {'auxiliary_fan': '0',
 ...
 'machine_start_gcode': ';Geeetech official wiki homepage for MizarM: '
                        'https://www.geeetech.com/wiki/index.php/Mizar_M \n'
