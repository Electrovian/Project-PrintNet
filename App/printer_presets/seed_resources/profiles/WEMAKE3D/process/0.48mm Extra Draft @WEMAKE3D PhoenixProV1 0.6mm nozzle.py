...
# source: profiles/WEMAKE3D/process/0.48mm Extra Draft @WEMAKE3D PhoenixProV1 0.6mm nozzle.json
DATA = {'compatible_printers': ['WEMAKE3D PhoenixProV1 0.6mm nozzle'],
