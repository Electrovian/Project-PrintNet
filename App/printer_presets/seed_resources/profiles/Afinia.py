...
# source: profiles/Afinia.json
DATA = {'description': 'Afinia configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Afinia Value PLA', 'sub_path': 'filament/Afinia Value PLA.json'},
                   {'name': 'Afinia ABS', 'sub_path': 'filament/Afinia ABS.json'},
                   {'name': 'Afinia ABS+', 'sub_path': 'filament/Afinia ABS+.json'},
                   {'name': 'Afinia Value ABS', 'sub_path': 'filament/Afinia Value ABS.json'},
                   {'name': 'Afinia TPU', 'sub_path': 'filament/Afinia TPU.json'},
                   {'name': 'Afinia PLA@HS', 'sub_path': 'filament/Afinia PLA@HS.json'},
                   {'name': 'Afinia Value PLA@HS', 'sub_path': 'filament/Afinia Value PLA@HS.json'},
                   {'name': 'Afinia ABS@HS', 'sub_path': 'filament/Afinia ABS@HS.json'},
                   {'name': 'Afinia Value ABS@HS', 'sub_path': 'filament/Afinia Value ABS@HS.json'},
                   {'name': 'Afinia ABS+@HS', 'sub_path': 'filament/Afinia ABS+@HS.json'},
                   {'name': 'Afinia TPU@HS', 'sub_path': 'filament/Afinia TPU@HS.json'}],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'fdm_afinia_common', 'sub_path': 'machine/fdm_afinia_common.json'},
                  {'name': 'Afinia H+1(HS) 0.4 nozzle', 'sub_path': 'machine/Afinia H+1(HS) 0.4 nozzle.json'},
                  {'name': 'Afinia H+1(HS) 0.6 nozzle', 'sub_path': 'machine/Afinia H+1(HS) 0.6 nozzle.json'}],
 'machine_model_list': [{'name': 'Afinia H+1(HS)', 'sub_path': 'machine/Afinia H+1(HS).json'}],
 'name': 'Afinia',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  {'name': 'fdm_process_afinia_common', 'sub_path': 'process/fdm_process_afinia_common.json'},
                  {'name': 'fdm_process_afinia_HS_common', 'sub_path': 'process/fdm_process_afinia_HS_common.json'},
                  {'name': '0.12mm Fine @Afinia H+1(HS)', 'sub_path': 'process/0.12mm Fine @Afinia H+1(HS).json'},
                  {'name': '0.16mm Optimal @Afinia H+1(HS)', 'sub_path': 'process/0.16mm Optimal @Afinia H+1(HS).json'},
                  {'name': '0.20mm Standard @Afinia H+1(HS)',
                   'sub_path': 'process/0.20mm Standard @Afinia H+1(HS).json'},
                  {'name': '0.24mm Draft @Afinia H+1(HS)', 'sub_path': 'process/0.24mm Draft @Afinia H+1(HS).json'},
