...
# source: profiles/OpenEYE.json
DATA = {'description': 'OpenEYE Printers Configurations',
 'filament_list': [],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'fdm_openeye_common', 'sub_path': 'machine/fdm_openeye_common.json'},
                  {'name': 'OpenEYE Peacock V2 0.4 nozzle', 'sub_path': 'machine/OpenEYE Peacock V2 0.4 nozzle.json'},
                  {'name': 'OpenEYE Peacock V2 0.2 nozzle', 'sub_path': 'machine/OpenEYE Peacock V2 0.2 nozzle.json'},
                  {'name': 'OpenEYE Peacock V2 0.6 nozzle', 'sub_path': 'machine/OpenEYE Peacock V2 0.6 nozzle.json'},
                  {'name': 'OpenEYE Peacock V2 0.8 nozzle', 'sub_path': 'machine/OpenEYE Peacock V2 0.8 nozzle.json'}],
 'machine_model_list': [{'name': 'OpenEYE Peacock V2', 'sub_path': 'machine/OpenEYE Peacock V2.json'}],
 'name': 'OpenEYE',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  {'name': 'fdm_process_openeye_common', 'sub_path': 'process/fdm_process_openeye_common.json'},
