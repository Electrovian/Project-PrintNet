...
# source: profiles/FlyingBear/machine/S1/FlyingBear S1 0.4 nozzle.json
DATA = {'auxiliary_fan': '1',
 ...
 'default_filament_profile': ['FlyingBear PLA @S1'],
 ...
 'machine_start_gcode': ';v2.9.3-20250610;\n'
                        ';wiping nozzle start\n'
                        'M106 P3 S0\n'
                        'M140 S60\n'
                        ...
                        'G1 X5 Y5 F8000 \n'
                        'G28 \n'
                        'G1 X{first_layer_print_min[0]-1.5} Y{min(first_layer_print_min[1] + 100,print_bed_max[0])} '
                        'F6000 \n'
                        'G1 Z0 F400\n'
