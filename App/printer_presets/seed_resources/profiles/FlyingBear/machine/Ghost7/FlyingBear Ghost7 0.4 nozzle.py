...
# source: profiles/FlyingBear/machine/Ghost7/FlyingBear Ghost7 0.4 nozzle.json
DATA = {'auxiliary_fan': '1',
 'bed_exclude_area': ['242x0', '250x0', '250x30', '242x30'],
 ...
 'default_filament_profile': ['FlyingBear PLA Basic @Ghost7'],
 ...
 'machine_start_gcode': ';v1.0.1-20250822;\n'
                        ...
                        'PRINT_START\n'
                        ';*************PRINT START*************\n'
                        'G1 X{first_layer_print_min[0]-1.5} Y{min(first_layer_print_min[1] + 80,print_bed_max[0])} '
                        'F6000 ;move head to drawing line position\n'
                        'G1 Z0 F100\n'
