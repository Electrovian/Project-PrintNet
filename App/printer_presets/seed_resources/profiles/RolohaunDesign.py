...
# source: profiles/RolohaunDesign.json
DATA = {'description': 'RolohaunDesign Printer Profiles',
 'filament_list': [],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'fdm_common_Rook MK1 LDO', 'sub_path': 'machine/fdm_common_Rook MK1 LDO.json'},
                  {'name': 'Rolohaun Delta Flyer Refit 0.4 nozzle',
                   'sub_path': 'machine/Rolohaun Delta Flyer Refit 0.4 nozzle.json'},
                  {'name': 'Rook MK1 LDO 0.2 nozzle', 'sub_path': 'machine/Rook MK1 LDO 0.2 nozzle.json'},
                  {'name': 'Rook MK1 LDO 0.4 nozzle', 'sub_path': 'machine/Rook MK1 LDO 0.4 nozzle.json'},
                  {'name': 'Rook MK1 LDO 0.6 nozzle', 'sub_path': 'machine/Rook MK1 LDO 0.6 nozzle.json'},
                  {'name': 'Rook MK1 LDO 0.8 nozzle', 'sub_path': 'machine/Rook MK1 LDO 0.8 nozzle.json'}],
 'machine_model_list': [{'name': 'Rolohaun Delta Flyer Refit', 'sub_path': 'machine/Rolohaun Delta Flyer Refit.json'},
                        {'name': 'Rook MK1 LDO', 'sub_path': 'machine/Rook MK1 LDO.json'}],
 'name': 'RolohaunDesign',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  ...
                  {'name': '0.12mm Fine @Rook MK1 LDO', 'sub_path': 'process/0.12mm Fine @Rook MK1 LDO.json'},
                  {'name': '0.16mm Optimal @Delta Flyer Refit',
                   'sub_path': 'process/0.16mm Optimal @Rolohaun Delta Flyer Refit.json'},
                  {'name': '0.16mm Optimal @Rook MK1 LDO', 'sub_path': 'process/0.16mm Optimal @Rook MK1 LDO.json'},
                  {'name': '0.20mm Standard @Delta Flyer Refit',
                   'sub_path': 'process/0.20mm Standard @Rolohaun Delta Flyer Refit.json'},
                  {'name': '0.20mm Standard @Rook MK1 LDO', 'sub_path': 'process/0.20mm Standard @Rook MK1 LDO.json'},
                  {'name': '0.24mm Draft @Delta Flyer Refit',
                   'sub_path': 'process/0.24mm Draft @Rolohaun Delta Flyer Refit.json'},
                  {'name': '0.24mm Draft @Rook MK1 LDO', 'sub_path': 'process/0.24mm Draft @Rook MK1 LDO.json'},
