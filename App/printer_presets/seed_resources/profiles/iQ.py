...
# source: profiles/iQ.json
DATA = {'description': 'innovatiQ configuration',
 ...
 'force_update': '1',
 'machine_list': [{'name': 'fdm_tiq_common', 'sub_path': 'machine/fdm_tiq_common.json'},
                  {'name': 'iQ TiQ2 0.4 Nozzle', 'sub_path': 'machine/iQ TiQ2 0.4 nozzle.json'},
                  {'name': 'iQ TiQ2 0.25 Nozzle', 'sub_path': 'machine/iQ TiQ2 0.25 nozzle.json'},
                  {'name': 'iQ TiQ2 0.6 Nozzle', 'sub_path': 'machine/iQ TiQ2 0.6 nozzle.json'},
                  {'name': 'iQ TiQ2 0.8 Nozzle', 'sub_path': 'machine/iQ TiQ2 0.8 nozzle.json'},
                  {'name': 'iQ TiQ8 0.4 Nozzle', 'sub_path': 'machine/iQ TiQ8 0.4 nozzle.json'},
                  {'name': 'iQ TiQ8 0.25 Nozzle', 'sub_path': 'machine/iQ TiQ8 0.25 nozzle.json'},
                  {'name': 'iQ TiQ8 0.6 Nozzle', 'sub_path': 'machine/iQ TiQ8 0.6 nozzle.json'},
                  {'name': 'iQ TiQ8 0.8 Nozzle', 'sub_path': 'machine/iQ TiQ8 0.8 nozzle.json'}],
 'machine_model_list': [{'name': 'TiQ2', 'sub_path': 'machine/TiQ2.json'},
                        {'name': 'TiQ8', 'sub_path': 'machine/TiQ8.json'}],
 'name': 'innovatiQ',
 'process_list': [{'name': 'fdm_process_tiq_common', 'sub_path': 'process/fdm_process_tiq_common.json'},
                  ...
                  {'name': '0.20mm Standard @iQ TiQ2 P2 - PACF Pro Fiberthree + VXL90 Xioneer (0.4 Nozzle)',
                   'sub_path': 'process/0.20mm Standard @iQ TiQ2 P2 - PACF Pro Fiberthree + VXL90 Xioneer (0.4 '
                               'Nozzle).json'},
