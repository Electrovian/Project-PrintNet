...
# source: profiles/Creality/process/0.36mm SuperChunky @Creality CR-6 0.6.json
DATA = {'compatible_printers': ['Creality CR-6 SE 0.6 nozzle', 'Creality CR-6 Max 0.6 nozzle'],
 'from': 'system',
