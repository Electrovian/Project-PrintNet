...
# source: profiles/Creality/machine/Creality Ender-5 Plus 0.4 nozzle.json
DATA = {'auxiliary_fan': '0',
 ...
 'machine_end_gcode': '{if max_layer_z < printable_height}G1 Z{z_offset+min(max_layer_z+2, printable_height)} '
                      ...
                      '{if max_layer_z < printable_height-10}G1 Z{z_offset+ printable_height-10} F600{endif} ; Move '
                      'print bed close to the bottom\n'
