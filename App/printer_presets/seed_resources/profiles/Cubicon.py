...
# source: profiles/Cubicon.json
DATA = {'description': 'Cubicon configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Cubicon PLA @base', 'sub_path': 'filament/Cubicon PLA @base.json'},
                   ...
                   {'name': 'Cubicon PLA+ @Cubicon xCeler-Plus 0.4 nozzle',
                    'sub_path': 'filament/Cubicon PLA+ @Cubicon xCeler-Plus 0.4 nozzle.json'},
                   {'name': 'Cubicon PLAi21 @base', 'sub_path': 'filament/Cubicon PLAi21 @base.json'},
                   ...
                   {'name': 'Cubicon ABS @base', 'sub_path': 'filament/Cubicon ABS @base.json'},
                   ...
                   {'name': 'Cubicon ABSk @base', 'sub_path': 'filament/Cubicon ABSk @base.json'},
                   ...
                   {'name': 'Cubicon ABS-A100 @base', 'sub_path': 'filament/Cubicon ABS-A100 @base.json'},
                   ...
                   {'name': 'Cubicon PETG @base', 'sub_path': 'filament/Cubicon PETG @base.json'},
                   ...
                   {'name': 'Cubicon PC @base', 'sub_path': 'filament/Cubicon PC @base.json'},
                   ...
                   {'name': 'Cubicon PA-CF @base', 'sub_path': 'filament/Cubicon PA-CF @base.json'},
 ...
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'Cubicon xCeler-I 0.4 nozzle', 'sub_path': 'machine/Cubicon xCeler-I 0.4 nozzle.json'},
                  {'name': 'Cubicon xCeler-Plus 0.4 nozzle',
                   'sub_path': 'machine/Cubicon xCeler-Plus 0.4 nozzle.json'}],
 'machine_model_list': [{'name': 'Cubicon xCeler-I', 'sub_path': 'machine/Cubicon xCeler-I.json'},
                        {'name': 'Cubicon xCeler-Plus', 'sub_path': 'machine/Cubicon xCeler-Plus.json'}],
 'name': 'Cubicon',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  ...
                  {'name': 'process template @base', 'sub_path': 'process/process template @base.json'},
                  {'name': 'cubicon common @base', 'sub_path': 'process/cubicon common @base.json'},
