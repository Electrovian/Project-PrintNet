...
# source: profiles/Elegoo/machine/Elegoo OrangeStorm Giga 0.4 nozzle.json
DATA = {'auxiliary_fan': '0',
 'change_filament_gcode': 'M600',
 'default_filament_profile': ['Elegoo PLA @Elegoo Giga'],
 ...
 'layer_change_gcode': ';LAYER:{layer_num+1}\n'
                       ...
                       ';Case 1\n'
                       'M140 S0\n'
                       '{if (min(print_bed_max[0], first_layer_print_min[0] + 32) - 32) < 405 && (max(0, '
                       'first_layer_print_min[1])) < 402.5}\n'
                       'M140 T0 S[bed_temperature_initial_layer_single]\n'
                       '{if ((min(print_bed_max[0], max(first_layer_print_min[0] + 32, first_layer_print_max[0])))) > '
                       '405}\n'
                       ...
                       '{endif}\n'
                       '{if ((min(print_bed_max[0], max(first_layer_print_min[0] + 32, first_layer_print_max[0])))) > '
                       '405 && ((first_layer_print_max[1])) > 402.5}\n'
 ...
 'machine_end_gcode': ';PRINT_END\n'
                      ...
                      'G1 X30 Y30 Z{min(max_layer_z+200, printable_height)} E-5 F{travel_speed*60} ; Move print head '
                      'up\n'
 ...
 'nozzle_height': '4.76',
 'nozzle_volume': '125',
 'printable_area': ['0x0', '810x0', '810x805', '0x805'],
 'printable_height': ['1010'],
 'printer_model': 'Elegoo OrangeStorm Giga',
 'printer_structure': 'i3',
 'printer_variant': '0.4',
 'retract_lift_below': ['1010'],
 'retraction_speed': ['45'],
 'scan_first_layer': '0',
 'setting_id': 'EOSG04',
 'thumbnails': ['400x400/COLPIC', '114x114/COLPIC', '160x160/PNG'],
