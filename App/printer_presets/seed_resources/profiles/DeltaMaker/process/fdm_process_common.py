...
# source: profiles/DeltaMaker/process/fdm_process_common.json
DATA = {'adaptive_layer_height': '0',
 ...
 'brim_type': 'no_brim',
 'brim_width': '4',
 'compatible_printers': ['DeltaMaker 2 0.35 nozzle', 'DeltaMaker 2T 0.5 nozzle', 'DeltaMaker 2XT 0.5 nozzle'],
