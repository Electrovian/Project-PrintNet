...
# source: profiles/Eryone/machine/fdm_machine_eryone_ER20_Klipper_common.json
DATA = {'auxiliary_fan': '0',
 ...
 'printer_notes': 'optimized Eryone ER20 Klipper configuration with E3D Hotend, BMG directdrive, printable height '
                  'limited to 190 because of the top of the directdrive and Z-Sync mod',
 'printer_variant': '0.5',
