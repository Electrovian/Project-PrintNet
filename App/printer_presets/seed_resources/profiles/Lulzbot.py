...
# source: profiles/Lulzbot.json
DATA = {'description': 'Lulzbot configurations',
 'filament_list': [{'name': 'Lulzbot 2.85mm ABS', 'sub_path': 'filament/Lulzbot 2.85mm ABS.json'},
                   {'name': 'Lulzbot 2.85mm PETG', 'sub_path': 'filament/Lulzbot 2.85mm PETG.json'},
                   {'name': 'Lulzbot 2.85mm PLA', 'sub_path': 'filament/Lulzbot 2.85mm PLA.json'}],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'Lulzbot Taz 4 or 5 0.5 nozzle', 'sub_path': 'machine/Lulzbot Taz 4 or 5 0.5 nozzle.json'},
                  {'name': 'Lulzbot Taz 6 0.5 nozzle', 'sub_path': 'machine/Lulzbot Taz 6 0.5 nozzle.json'},
                  {'name': 'Lulzbot Taz Pro Common', 'sub_path': 'machine/Lulzbot Taz Pro Common.json'},
                  {'name': 'Lulzbot Taz Pro Dual 0.5 nozzle',
                   'sub_path': 'machine/Lulzbot Taz Pro Dual 0.5 nozzle.json'},
                  {'name': 'Lulzbot Taz Pro S 0.5 nozzle', 'sub_path': 'machine/Lulzbot Taz Pro S 0.5 nozzle.json'}],
 'machine_model_list': [{'name': 'Lulzbot Taz 4 or 5', 'sub_path': 'machine/Lulzbot Taz 4 or 5.json'},
                        {'name': 'Lulzbot Taz 6', 'sub_path': 'machine/Lulzbot Taz 6.json'},
                        {'name': 'Lulzbot Taz Pro Dual', 'sub_path': 'machine/Lulzbot Taz Pro Dual.json'},
                        {'name': 'Lulzbot Taz Pro S', 'sub_path': 'machine/Lulzbot Taz Pro S.json'}],
 'name': 'Lulzbot',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  ...
                  {'name': '0.25mm Standard @Lulzbot Taz 6', 'sub_path': 'process/0.25mm Standard @Lulzbot Taz 6.json'},
