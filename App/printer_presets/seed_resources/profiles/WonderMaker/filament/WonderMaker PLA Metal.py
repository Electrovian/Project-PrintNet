...
# source: profiles/WonderMaker/filament/WonderMaker PLA Metal.json
DATA = {'compatible_printers': ['WonderMaker ZR 0.2 nozzle',
 ...
 'description': 'To make the prints get higher gloss, please dry the filament before use, and set the outer wall speed '
