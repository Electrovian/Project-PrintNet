...
# source: profiles/Wanhao France.json
DATA = {'description': 'Wanhao France D12 configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Yumi Generic PETG', 'sub_path': 'filament/Yumi Generic PETG.json'},
                   {'name': 'Yumi Generic PLA', 'sub_path': 'filament/Yumi Generic PLA.json'},
                   {'name': 'YUMI PETG', 'sub_path': 'filament/YUMI PETG.json'},
                   {'name': 'YUMI PLA Bowden', 'sub_path': 'filament/YUMI PLA Bowden.json'},
                   {'name': 'YUMI PLA Direct Drive', 'sub_path': 'filament/YUMI PLA Direct Drive.json'}],
 'force_update': '0',
 ...
 'machine_model_list': [{'name': 'D12 230 PRO M2 DIRECT', 'sub_path': 'machine/D12 230 PRO M2 DIRECT.json'},
                        {'name': 'D12 230 PRO M2 MONO DUAL', 'sub_path': 'machine/D12 230 PRO M2 MONO DUAL.json'},
                        {'name': 'D12 230 PRO M2 MONO DUAL PoopTool',
                         'sub_path': 'machine/D12 230 PRO M2 MONO DUAL PoopTool.json'},
                        {'name': 'D12 230 PRO SMARTPAD DIRECT', 'sub_path': 'machine/D12 230 PRO SMARTPAD DIRECT.json'},
                        ...
                        {'name': 'D12 300 PRO M2 DIRECT', 'sub_path': 'machine/D12 300 PRO M2 DIRECT.json'},
                        {'name': 'D12 300 PRO M2 MONO DUAL', 'sub_path': 'machine/D12 300 PRO M2 MONO DUAL.json'},
                        {'name': 'D12 300 PRO M2 MONO DUAL PoopTool',
                         'sub_path': 'machine/D12 300 PRO M2 MONO DUAL PoopTool.json'},
                        {'name': 'D12 300 PRO SMARTPAD DIRECT', 'sub_path': 'machine/D12 300 PRO SMARTPAD DIRECT.json'},
                        ...
                        {'name': 'D12 500 PRO M2 DIRECT', 'sub_path': 'machine/D12 500 PRO M2 DIRECT.json'},
                        {'name': 'D12 500 PRO M2 MONO DUAL', 'sub_path': 'machine/D12 500 PRO M2 MONO DUAL.json'},
                        {'name': 'D12 500 PRO M2 MONO DUAL PoopTool',
                         'sub_path': 'machine/D12 500 PRO M2 MONO DUAL PoopTool.json'},
                        {'name': 'D12 500 PRO SMARTPAD DIRECT', 'sub_path': 'machine/D12 500 PRO SMARTPAD DIRECT.json'},
