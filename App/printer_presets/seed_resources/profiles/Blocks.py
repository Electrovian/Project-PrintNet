...
# source: profiles/Blocks.json
DATA = {'description': 'Blocks configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Blocks Generic ABS', 'sub_path': 'filament/Blocks Generic ABS.json'},
                   {'name': 'Blocks Generic ASA', 'sub_path': 'filament/Blocks Generic ASA.json'},
                   {'name': 'Blocks Generic ASA-CF', 'sub_path': 'filament/Blocks Generic ASA-CF.json'},
                   {'name': 'Blocks Generic PA', 'sub_path': 'filament/Blocks Generic PA.json'},
                   {'name': 'Blocks Generic PA-CF', 'sub_path': 'filament/Blocks Generic PA-CF.json'},
                   {'name': 'Blocks Generic PC', 'sub_path': 'filament/Blocks Generic PC.json'},
                   {'name': 'Blocks Generic PETG', 'sub_path': 'filament/Blocks Generic PETG.json'},
                   {'name': 'Blocks Generic PLA', 'sub_path': 'filament/Blocks Generic PLA.json'},
                   {'name': 'Blocks Generic PLA-CF', 'sub_path': 'filament/Blocks Generic PLA-CF.json'},
                   {'name': 'Blocks Generic PVA', 'sub_path': 'filament/Blocks Generic PVA.json'},
                   {'name': 'Blocks Generic TPU', 'sub_path': 'filament/Blocks Generic TPU.json'}],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  ...
                  {'name': 'BLOCKS Pro S100 0.4 nozzle', 'sub_path': 'machine/BLOCKS Pro S100 0.4 nozzle.json'},
                  {'name': 'BLOCKS Pro S100 0.6 nozzle', 'sub_path': 'machine/BLOCKS Pro S100 0.6 nozzle.json'},
                  {'name': 'BLOCKS Pro S100 0.8 nozzle', 'sub_path': 'machine/BLOCKS Pro S100 0.8 nozzle.json'},
                  {'name': 'BLOCKS Pro S100 1.0 nozzle', 'sub_path': 'machine/BLOCKS Pro S100 1.0 nozzle.json'},
                  {'name': 'BLOCKS Pro S100 1.2 nozzle', 'sub_path': 'machine/BLOCKS Pro S100 1.2 nozzle.json'},
                  {'name': 'BLOCKS RD50 V2 0.4 nozzle', 'sub_path': 'machine/BLOCKS RD50 V2 0.4 nozzle.json'},
                  {'name': 'BLOCKS RD50 V2 0.6 nozzle', 'sub_path': 'machine/BLOCKS RD50 V2 0.6 nozzle.json'},
                  {'name': 'BLOCKS RD50 V2 0.8 nozzle', 'sub_path': 'machine/BLOCKS RD50 V2 0.8 nozzle.json'},
                  {'name': 'BLOCKS RF50 0.4 nozzle', 'sub_path': 'machine/BLOCKS RF50 0.4 nozzle.json'},
                  {'name': 'BLOCKS RF50 0.6 nozzle', 'sub_path': 'machine/BLOCKS RF50 0.6 nozzle.json'},
                  {'name': 'BLOCKS RF50 0.8 nozzle', 'sub_path': 'machine/BLOCKS RF50 0.8 nozzle.json'}],
 'machine_model_list': [{'name': 'BLOCKS Pro S100', 'sub_path': 'machine/BLOCKS Pro S100.json'},
                        {'name': 'BLOCKS RD50 V2', 'sub_path': 'machine/BLOCKS RD50 V2.json'},
                        {'name': 'BLOCKS RF50', 'sub_path': 'machine/BLOCKS RF50.json'}],
 'name': 'Blocks',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  {'name': 'fdm_process_blocks_common', 'sub_path': 'process/fdm_process_blocks_common.json'},
                  ...
                  {'name': 'fdm_process_common 0.6 nozzle', 'sub_path': 'process/fdm_process_common 0.6 nozzle.json'},
                  {'name': 'fdm_process_common 0.8 nozzle', 'sub_path': 'process/fdm_process_common 0.8 nozzle.json'},
                  {'name': 'fdm_process_common 1.0 nozzle', 'sub_path': 'process/fdm_process_common 1.0 nozzle.json'},
                  {'name': 'fdm_process_common 1.2 nozzle', 'sub_path': 'process/fdm_process_common 1.2 nozzle.json'},
