...
# source: profiles/Artillery/filament/Artillery PETG @Artillery M1 Pro 0.6 nozzle.json
DATA = {'activate_air_filtration': ['0'],
 ...
 'compatible_printers': ['Artillery M1 Pro 0.6 nozzle'],
 ...
 'filament_settings_id': ['Artillery PETG @Artillery M1 Pro 0.6 nozzle'],
 'filament_shrink': ['100%'],
