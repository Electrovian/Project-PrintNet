...
# source: profiles/Artillery/filament/Artillery PET @Artillery M1 Pro 0.2 nozzle.json
DATA = {'activate_air_filtration': ['0'],
 ...
 'compatible_printers': ['Artillery M1 Pro 0.2 nozzle'],
 ...
 'filament_settings_id': ['Artillery PET @Artillery M1 Pro 0.2 nozzle'],
 'filament_shrink': ['100%'],
