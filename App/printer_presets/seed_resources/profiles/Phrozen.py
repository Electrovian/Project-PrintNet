...
# source: profiles/Phrozen.json
DATA = {'description': 'Phrozen configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'fdm_filament_asa', 'sub_path': 'filament/fdm_filament_asa.json'},
                   {'name': 'fdm_filament_pa', 'sub_path': 'filament/fdm_filament_pa.json'},
                   ...
                   {'name': 'fdm_filament_pva', 'sub_path': 'filament/fdm_filament_pva.json'},
 ...
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'Phrozen Arco 0.4 nozzle', 'sub_path': 'machine/Phrozen Arco 0.4 nozzle.json'}],
