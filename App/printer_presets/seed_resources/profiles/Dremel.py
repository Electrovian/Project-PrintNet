...
# source: profiles/Dremel.json
DATA = {'description': 'Dremel configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Dremel Generic PLA @3D20 all', 'sub_path': 'filament/Dremel Generic PLA @3D20 all.json'},
                   {'name': 'Dremel Generic PLA @3D40 all', 'sub_path': 'filament/Dremel Generic PLA @3D40 all.json'},
 ...
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  ...
                  {'name': 'Dremel 3D20 0.4 nozzle', 'sub_path': 'machine/Dremel 3D20 0.4 nozzle.json'},
                  {'name': 'Dremel 3D40 0.4 nozzle', 'sub_path': 'machine/Dremel 3D40 0.4 nozzle.json'},
                  {'name': 'Dremel 3D45 0.4 nozzle', 'sub_path': 'machine/Dremel 3D45 0.4 nozzle.json'}],
 'machine_model_list': [{'name': 'Dremel 3D20', 'sub_path': 'machine/Dremel 3D20.json'},
                        {'name': 'Dremel 3D40', 'sub_path': 'machine/Dremel 3D40.json'},
 ...
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  ...
                  {'name': '.10mm Detail @Dremel 3D20 0.4', 'sub_path': 'process/.10mm Detail @Dremel 3D20 0.4.json'},
                  {'name': '.10mm Detail @Dremel 3D40 0.4', 'sub_path': 'process/.10mm Detail @Dremel 3D40 0.4.json'},
                  {'name': '.10mm Detail @Dremel 3D45 0.4', 'sub_path': 'process/.10mm Detail @Dremel 3D45 0.4.json'},
                  ...
                  {'name': '.30mm Draft @Dremel 3D20 0.4', 'sub_path': 'process/.30mm Draft @Dremel 3D20 0.4.json'},
                  {'name': '.30mm Draft @Dremel 3D40 0.4', 'sub_path': 'process/.30mm Draft @Dremel 3D40 0.4.json'},
                  {'name': '.30mm Draft @Dremel 3D45 0.4', 'sub_path': 'process/.30mm Draft @Dremel 3D45 0.4.json'},
