...
# source: profiles/Prusa/machine/Prusa CORE One HF 0.4 nozzle.json
DATA = {'before_layer_change_gcode': [';BEFORE_LAYER_CHANGE\n'
                               'G92 E0.0\n'
                               ';[layer_z]\n'
                               '{if layer_z > 150}\n'
                               'M201 X{interpolate_table(layer_z, (0,7000), (150,7000), (200,4000), (270,2000))} '
                               'Y{interpolate_table(layer_z, (0,7000), (150,7000), (200,4000), (270,2000))}\n'
                               '{endif}\n'],
 ...
 'machine_start_gcode': ['; --- Printer Initialization and Checks ---\n'
                         ...
                         '32))} H{((first_layer_print_max[1])) - ((max(0, first_layer_print_min[1]) - 4))} ; define '
                         'print area\n'
                         '\n'
                         ...
                         '{endif}\n'
                         '\n'
                         'M109 R{((filament_notes[0]=~/.*HT_MBL10.*/) ? (first_layer_temperature[0] - 10) : '
                         '(filament_type[0] == "PC" or filament_type[0] == "PA") ? (first_layer_temperature[0] - 25) : '
                         '(filament_type[0] == "FLEX") ? 210 : 170)} ; wait for temp\n'
                         '\n'
                         ...
                         '0}100{else}{idle_temperature[initial_tool]}{endif} ; set idle temp\n'
                         ...
                         '\n'
                         '{else}\n'
                         'M141 S{if chamber_temperature[initial_tool] == '
                         '0}20{else}{chamber_temperature[initial_tool]}{endif} ; set nominal chamber temp\n'
                         '{endif}\n'
                         '\n'
                         '{if first_layer_bed_temperature[initial_tool]<=60}M106 S70{endif}\n'
                         'G0 Z40 F10000\n'
                         'M104 T{initial_tool} S{if idle_temperature[initial_tool] == '
                         '0}100{else}{idle_temperature[initial_tool]}{endif}\n'
                         ...
                         'M109 R{((filament_notes[0]=~/.*HT_MBL10.*/) ? (first_layer_temperature[0] - 10) : '
                         '(filament_type[0] == "PC" or filament_type[0] == "PA") ? (first_layer_temperature[0] - 25) : '
                         '(filament_type[0] == "FLEX") ? 210 : 170)} ; wait for MBL temp\n'
                         '\n'
