...
# source: profiles/Prusa/process/process_common_mk3.json
DATA = {'bottom_shell_thickness': '0.5',
 ...
 'brim_width': '0',
 'compatible_printers': '',
 'compatible_printers_condition': 'printer_notes=~/.*PRINTER_VENDOR_PRUSA3D.*/ and '
                                  'printer_notes=~/.*PRINTER_MODEL_MK3.*/ and nozzle_diameter[0]==0.4',
