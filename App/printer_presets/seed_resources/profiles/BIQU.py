...
# source: profiles/BIQU.json
DATA = {'description': 'BIQU configurations',
 'filament_list': [],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  {'name': 'fdm_biqu_common', 'sub_path': 'machine/fdm_biqu_common.json'},
                  {'name': 'fdm_klipper_common', 'sub_path': 'machine/fdm_klipper_common.json'},
                  {'name': 'BIQU B1 (0.4 nozzle)', 'sub_path': 'machine/BIQU B1 (0.4 nozzle).json'},
                  {'name': 'BIQU BX (0.4 nozzle)', 'sub_path': 'machine/BIQU BX (0.4 nozzle).json'},
                  {'name': 'BIQU Hurakan (0.4 nozzle)', 'sub_path': 'machine/BIQU Hurakan (0.4 nozzle).json'}],
 'machine_model_list': [{'name': 'BIQU B1', 'sub_path': 'machine/BIQU B1.json'},
                        {'name': 'BIQU BX', 'sub_path': 'machine/BIQU BX.json'},
                        {'name': 'BIQU Hurakan', 'sub_path': 'machine/BIQU Hurakan.json'}],
 'name': 'BIQU',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  {'name': 'fdm_process_biqu_common', 'sub_path': 'process/fdm_process_biqu_common.json'},
                  ...
                  {'name': 'fdm_process_hurakan_common', 'sub_path': 'process/fdm_process_hurakan_common.json'},
