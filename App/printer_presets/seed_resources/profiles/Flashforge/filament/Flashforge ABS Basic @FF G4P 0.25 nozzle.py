...
# source: profiles/Flashforge/filament/Flashforge ABS Basic @FF G4P 0.25 nozzle.json
DATA = {'compatible_printers': ['Flashforge Guider4 Pro 0.25 nozzle'],
 ...
 'filament_settings_id': ['Flashforge ABS Basic @FF G4P 0.25 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['100'],
