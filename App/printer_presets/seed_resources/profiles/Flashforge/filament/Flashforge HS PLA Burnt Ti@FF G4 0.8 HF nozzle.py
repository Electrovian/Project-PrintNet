...
# source: profiles/Flashforge/filament/Flashforge HS PLA Burnt Ti@FF G4 0.8 HF nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge HS PLA Burnt Ti@FF G4 0.8 HF nozzle'],
