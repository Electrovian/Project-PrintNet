...
# source: profiles/Flashforge/filament/Flashforge PLA Galaxy @FF G4P.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PLA Galaxy @FF G4P'],
 'filament_start_gcode': ['; filament start gcode\n;right_extruder_material:PLA\n'],
 'from': 'system',
 'hot_plate_temp': ['55'],
 'inherits': 'Flashforge Generic HS PLA',
 'instantiation': 'true',
 'name': 'Flashforge PLA Galaxy @FF G4P',
