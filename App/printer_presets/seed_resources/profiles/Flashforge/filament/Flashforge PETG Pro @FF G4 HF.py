...
# source: profiles/Flashforge/filament/Flashforge PETG Pro @FF G4 HF.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PETG Pro @FF G4 HF'],
 ...
 'instantiation': 'true',
 'name': 'Flashforge PETG Pro @FF G4 HF',
