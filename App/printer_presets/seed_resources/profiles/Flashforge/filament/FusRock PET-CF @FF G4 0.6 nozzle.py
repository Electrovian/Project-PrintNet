...
# source: profiles/Flashforge/filament/FusRock PET-CF @FF G4 0.6 nozzle.json
DATA = {'compatible_printers': ['Flashforge Guider4 0.6 nozzle'],
 ...
 'filament_settings_id': ['FusRock PET-CF @FF G4 0.6 nozzle'],
