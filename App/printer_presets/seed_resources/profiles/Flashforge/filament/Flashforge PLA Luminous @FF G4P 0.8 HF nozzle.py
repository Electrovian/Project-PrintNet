...
# source: profiles/Flashforge/filament/Flashforge PLA Luminous @FF G4P 0.8 HF nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PLA Luminous @FF G4P 0.8 HF nozzle'],
