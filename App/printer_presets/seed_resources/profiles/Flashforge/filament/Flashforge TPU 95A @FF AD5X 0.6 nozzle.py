...
# source: profiles/Flashforge/filament/Flashforge TPU 95A @FF AD5X 0.6 nozzle.json
DATA = {'compatible_printers': ['Flashforge AD5X 0.6 nozzle'],
 ...
 'filament_settings_id': ['Flashforge TPU 95A @FF AD5X 0.6 nozzle'],
 'from': 'system',
 'inherits': 'Flashforge Generic TPU',
 'instantiation': 'true',
 'name': 'Flashforge TPU 95A @FF AD5X 0.6 nozzle',
