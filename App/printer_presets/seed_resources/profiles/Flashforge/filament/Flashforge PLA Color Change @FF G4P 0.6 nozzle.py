...
# source: profiles/Flashforge/filament/Flashforge PLA Color Change @FF G4P 0.6 nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PLA Color Change @FF G4P 0.6 nozzle'],
