...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF G4P 0.6 nozzle.json
DATA = {'additional_cooling_fan_speed': ['40'],
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF G4P 0.6 nozzle'],
