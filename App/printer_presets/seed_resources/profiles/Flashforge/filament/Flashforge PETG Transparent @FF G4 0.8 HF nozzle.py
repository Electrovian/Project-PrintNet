...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF G4 0.8 HF nozzle.json
DATA = {'additional_cooling_fan_speed': ['40'],
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF G4 0.8 HF nozzle'],
