...
# source: profiles/Flashforge/filament/Flashforge PLA Color Change @FF G4 0.25 nozzle.json
DATA = {'additional_cooling_fan_speed': ['40'],
 ...
 'filament_settings_id': ['Flashforge PLA Color Change @FF G4 0.25 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['55'],
