...
# source: profiles/Flashforge/filament/Generic TPU 85A @FF AD5X 0.8 nozzle.json
DATA = {'compatible_printers': ['Flashforge AD5X 0.8 nozzle'],
 ...
 'filament_settings_id': ['Generic TPU 85A @FF AD5X 0.8 nozzle'],
 'from': 'system',
 'inherits': 'Flashforge Generic TPU',
 'instantiation': 'true',
 'name': 'Generic TPU 85A @FF AD5X 0.8 nozzle',
