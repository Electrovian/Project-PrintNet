...
# source: profiles/Flashforge/filament/FlashForge PPS-CF @FF G4 0.6 nozzle.json
DATA = {'close_fan_the_first_x_layers': ['2'],
 ...
 'filament_settings_id': ['FlashForge PPS-CF @FF G4 0.6 nozzle'],
