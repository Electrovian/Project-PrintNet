...
# source: profiles/Flashforge/filament/Flashforge PA @FF G4P 0.6 HF nozzle.json
DATA = {'activate_chamber_temp_control': ['1'],
 ...
 'filament_settings_id': ['Flashforge PA @FF G4P 0.6 HF nozzle'],
 ...
 'nozzle_temperature_range_high': ['295'],
