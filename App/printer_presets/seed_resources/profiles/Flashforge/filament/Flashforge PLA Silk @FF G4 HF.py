...
# source: profiles/Flashforge/filament/Flashforge PLA Silk @FF G4 HF.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PLA Silk @FF G4 HF'],
 ...
 'instantiation': 'true',
 'name': 'Flashforge PLA Silk @FF G4 HF',
