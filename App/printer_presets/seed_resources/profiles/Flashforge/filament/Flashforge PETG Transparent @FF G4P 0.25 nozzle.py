...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF G4P 0.25 nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF G4P 0.25 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['80'],
