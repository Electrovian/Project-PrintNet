...
# source: profiles/Flashforge/filament/Flashforge PLA Pro @FF AD5X 0.6 nozzle.json
DATA = {'compatible_printers': ['Flashforge AD5X 0.6 nozzle'],
 ...
 'filament_settings_id': ['Flashforge PLA Pro @FF AD5X 0.6 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['60'],
 'hot_plate_temp_initial_layer': ['60'],
 'inherits': 'Flashforge Generic PLA',
 'instantiation': 'true',
 'name': 'Flashforge PLA Pro @FF AD5X 0.6 nozzle',
