...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF AD5X 0.25 nozzle.json
DATA = {'close_fan_the_first_x_layers': ['2'],
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF AD5X 0.25 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['75'],
