...
# source: profiles/Flashforge/filament/Flashforge PETG-CF @FF G4 0.6 nozzle.json
DATA = {'additional_cooling_fan_speed': ['0'],
 ...
 'filament_settings_id': ['Flashforge PETG-CF @FF G4 0.6 nozzle'],
 'filament_start_gcode': ['; filament start gcode\n;right_extruder_material:PETG'],
 'from': 'system',
 'hot_plate_temp': ['80'],
 'hot_plate_temp_initial_layer': ['80'],
 'inherits': 'Flashforge Generic PETG-CF @G3U 0.6 Nozzle',
 'instantiation': 'true',
