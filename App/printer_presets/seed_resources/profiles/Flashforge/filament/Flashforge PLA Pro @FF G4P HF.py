...
# source: profiles/Flashforge/filament/Flashforge PLA Pro @FF G4P HF.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PLA Pro @FF G4P HF'],
 ...
 'instantiation': 'true',
 'name': 'Flashforge PLA Pro @FF G4P HF',
