...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF AD5M 0.25 nozzle.json
DATA = {'compatible_printers': ['Flashforge Adventurer 5M 0.4 Nozzle',
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF AD5M 0.25 nozzle'],
 'from': 'system',
