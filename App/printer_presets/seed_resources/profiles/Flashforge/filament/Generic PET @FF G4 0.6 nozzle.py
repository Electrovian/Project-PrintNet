...
# source: profiles/Flashforge/filament/Generic PET @FF G4 0.6 nozzle.json
DATA = {'close_fan_the_first_x_layers': ['2'],
 ...
 'filament_settings_id': ['Generic PET @FF G4 0.6 nozzle'],
 ...
 'instantiation': 'true',
 'name': 'Generic PET @FF G4 0.6 nozzle',
