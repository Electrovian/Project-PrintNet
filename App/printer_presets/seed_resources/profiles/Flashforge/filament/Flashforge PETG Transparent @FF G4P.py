...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF G4P.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF G4P'],
 'from': 'system',
 'hot_plate_temp': ['80'],
 'hot_plate_temp_initial_layer': ['80'],
 'inherits': 'Flashforge Generic PETG',
 'instantiation': 'true',
 'name': 'Flashforge PETG Transparent @FF G4P',
