...
# source: profiles/Flashforge/filament/Flashforge PETG Transparent @FF G4 0.25 nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Flashforge PETG Transparent @FF G4 0.25 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['80'],
 'hot_plate_temp_initial_layer': ['80'],
 'inherits': 'Flashforge PETG @FF AD5M 0.25 Nozzle',
 'instantiation': 'true',
 'name': 'Flashforge PETG Transparent @FF G4 0.25 nozzle',
