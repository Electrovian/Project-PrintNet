...
# source: profiles/Flashforge/filament/Flashforge PLA Sparkle @FF AD5X 0.6 nozzle.json
DATA = {'compatible_printers': ['Flashforge AD5X 0.6 nozzle'],
 'cool_plate_temp': ['45'],
 'cool_plate_temp_initial_layer': ['45'],
 'eng_plate_temp_initial_layer': ['60'],
 'filament_max_volumetric_speed': ['21'],
 'filament_settings_id': ['Flashforge PLA Sparkle @FF AD5X 0.6 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['60'],
 'hot_plate_temp_initial_layer': ['60'],
 'inherits': 'Flashforge Generic PLA',
 'instantiation': 'true',
 'name': 'Flashforge PLA Sparkle @FF AD5X 0.6 nozzle',
