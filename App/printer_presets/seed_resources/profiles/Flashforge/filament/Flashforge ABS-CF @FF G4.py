...
# source: profiles/Flashforge/filament/Flashforge ABS-CF @FF G4.json
DATA = {'compatible_printers': ['Flashforge Guider4 0.4 nozzle'],
 ...
 'filament_settings_id': ['Flashforge ABS-CF @FF G4'],
