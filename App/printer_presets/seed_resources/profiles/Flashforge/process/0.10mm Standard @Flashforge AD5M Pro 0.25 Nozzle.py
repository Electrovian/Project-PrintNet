...
# source: profiles/Flashforge/process/0.10mm Standard @Flashforge AD5M Pro 0.25 Nozzle.json
DATA = {'compatible_printers': ['Flashforge Adventurer 5M Pro 0.25 Nozzle'],
