...
# source: profiles/Flashforge/machine/Flashforge Adventurer 5M Pro 0.6 Nozzle.json
DATA = {'default_print_profile': '0.30mm Standard @Flashforge AD5M Pro 0.6 Nozzle',
 'from': 'system',
