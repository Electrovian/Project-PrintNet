...
# source: profiles/Flashforge/machine/Flashforge Adventurer 5M Pro 0.25 Nozzle.json
DATA = {'default_print_profile': '0.12mm Standard @Flashforge AD5M Pro 0.25 Nozzle',
 'from': 'system',
