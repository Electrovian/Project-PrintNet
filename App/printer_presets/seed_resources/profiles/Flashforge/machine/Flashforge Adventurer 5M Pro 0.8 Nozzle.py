...
# source: profiles/Flashforge/machine/Flashforge Adventurer 5M Pro 0.8 Nozzle.json
DATA = {'default_print_profile': '0.40mm Standard @Flashforge AD5M Pro 0.8 Nozzle',
 'from': 'system',
