...
# source: profiles/Creality.json
DATA = {'description': 'Creality configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Creality Generic ASA', 'sub_path': 'filament/Creality Generic ASA.json'},
                   {'name': 'Creality Generic PA-CF', 'sub_path': 'filament/Creality Generic PA-CF.json'},
                   {'name': 'Creality Generic PC', 'sub_path': 'filament/Creality Generic PC.json'},
                   ...
                   {'name': 'Creality Generic PLA-CF', 'sub_path': 'filament/Creality Generic PLA-CF.json'},
                   {'name': 'Creality HF Generic PLA', 'sub_path': 'filament/Creality HF Generic PLA.json'},
                   {'name': 'Creality HF Generic Speed PLA', 'sub_path': 'filament/Creality HF Generic Speed PLA.json'},
                   ...
                   {'name': 'Creality Generic ABS @Hi-all', 'sub_path': 'filament/Creality Generic ABS @Hi-all.json'},
                   {'name': 'Creality Generic ABS @K1-all', 'sub_path': 'filament/Creality Generic ABS @K1-all.json'},
                   {'name': 'Creality Generic ABS @K2-all', 'sub_path': 'filament/Creality Generic ABS @K2-all.json'},
                   {'name': 'Creality Generic ASA @Ender-3V3-all',
                    'sub_path': 'filament/Creality Generic ASA @Ender-3V3-all.json'},
                   {'name': 'Creality Generic ASA @Hi-all', 'sub_path': 'filament/Creality Generic ASA @Hi-all.json'},
                   {'name': 'Creality Generic ASA @K1-all', 'sub_path': 'filament/Creality Generic ASA @K1-all.json'},
                   {'name': 'Creality Generic ASA @K2-all', 'sub_path': 'filament/Creality Generic ASA @K2-all.json'},
                   ...
                   {'name': 'Creality Generic PC @K1-all', 'sub_path': 'filament/Creality Generic PC @K1-all.json'},
                   {'name': 'Creality Generic PETG @Ender-3V3-all',
                    'sub_path': 'filament/Creality Generic PETG @Ender-3V3-all.json'},
                   {'name': 'Creality Generic PETG @Hi-all', 'sub_path': 'filament/Creality Generic PETG @Hi-all.json'},
                   {'name': 'Creality Generic PETG @K1-all', 'sub_path': 'filament/Creality Generic PETG @K1-all.json'},
                   {'name': 'Creality Generic PETG @K2-all', 'sub_path': 'filament/Creality Generic PETG @K2-all.json'},
                   {'name': 'Creality Generic PLA @Ender-3V3-all',
                    'sub_path': 'filament/Creality Generic PLA @Ender-3V3-all.json'},
                   {'name': 'Creality Generic PLA @Hi-all', 'sub_path': 'filament/Creality Generic PLA @Hi-all.json'},
                   {'name': 'Creality Generic PLA @K1-all', 'sub_path': 'filament/Creality Generic PLA @K1-all.json'},
                   {'name': 'Creality Generic PLA @K2-all', 'sub_path': 'filament/Creality Generic PLA @K2-all.json'},
                   ...
                   {'name': 'Creality Generic TPU @Hi-all', 'sub_path': 'filament/Creality Generic TPU @Hi-all.json'},
                   {'name': 'Creality Generic TPU @K1-all', 'sub_path': 'filament/Creality Generic TPU @K1-all.json'},
                   {'name': 'Creality Generic TPU @K2-all', 'sub_path': 'filament/Creality Generic TPU @K2-all.json'},
 ...
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  ...
                  {'name': 'Creality CR-10 Max 0.4 nozzle', 'sub_path': 'machine/Creality CR-10 Max 0.4 nozzle.json'},
                  {'name': 'Creality CR-10 SE 0.2 nozzle', 'sub_path': 'machine/Creality CR-10 SE 0.2 nozzle.json'},
                  {'name': 'Creality CR-10 SE 0.4 nozzle', 'sub_path': 'machine/Creality CR-10 SE 0.4 nozzle.json'},
                  {'name': 'Creality CR-10 SE 0.6 nozzle', 'sub_path': 'machine/Creality CR-10 SE 0.6 nozzle.json'},
                  {'name': 'Creality CR-10 SE 0.8 nozzle', 'sub_path': 'machine/Creality CR-10 SE 0.8 nozzle.json'},
                  {'name': 'Creality CR-10 V2 0.4 nozzle', 'sub_path': 'machine/Creality CR-10 V2 0.4 nozzle.json'},
                  {'name': 'Creality CR-10 V3 0.4 nozzle', 'sub_path': 'machine/Creality CR-10 V3 0.4 nozzle.json'},
                  {'name': 'Creality CR-10 V3 0.6 nozzle', 'sub_path': 'machine/Creality CR-10 V3 0.6 nozzle.json'},
                  {'name': 'Creality CR-6 Max 0.2 nozzle', 'sub_path': 'machine/Creality CR-6 Max 0.2 nozzle.json'},
                  {'name': 'Creality CR-6 Max 0.4 nozzle', 'sub_path': 'machine/Creality CR-6 Max 0.4 nozzle.json'},
                  {'name': 'Creality CR-6 Max 0.6 nozzle', 'sub_path': 'machine/Creality CR-6 Max 0.6 nozzle.json'},
                  {'name': 'Creality CR-6 Max 0.8 nozzle', 'sub_path': 'machine/Creality CR-6 Max 0.8 nozzle.json'},
                  {'name': 'Creality CR-6 SE 0.2 nozzle', 'sub_path': 'machine/Creality CR-6 SE 0.2 nozzle.json'},
                  {'name': 'Creality CR-6 SE 0.4 nozzle', 'sub_path': 'machine/Creality CR-6 SE 0.4 nozzle.json'},
                  {'name': 'Creality CR-6 SE 0.6 nozzle', 'sub_path': 'machine/Creality CR-6 SE 0.6 nozzle.json'},
                  {'name': 'Creality CR-6 SE 0.8 nozzle', 'sub_path': 'machine/Creality CR-6 SE 0.8 nozzle.json'},
                  {'name': 'Creality CR-M4 0.4 nozzle', 'sub_path': 'machine/Creality CR-M4 0.4 nozzle.json'},
                  {'name': 'Creality Ender-3 0.2 nozzle', 'sub_path': 'machine/Creality Ender-3 0.2 nozzle.json'},
                  {'name': 'Creality Ender-3 0.4 nozzle', 'sub_path': 'machine/Creality Ender-3 0.4 nozzle.json'},
                  {'name': 'Creality Ender-3 0.6 nozzle', 'sub_path': 'machine/Creality Ender-3 0.6 nozzle.json'},
                  {'name': 'Creality Ender-3 0.8 nozzle', 'sub_path': 'machine/Creality Ender-3 0.8 nozzle.json'},
                  ...
                  {'name': 'Creality Ender-3 S1 0.4 nozzle', 'sub_path': 'machine/Creality Ender-3 S1 0.4 nozzle.json'},
                  ...
                  {'name': 'Creality Ender-3 V3 0.4 nozzle', 'sub_path': 'machine/Creality Ender-3 V3 0.4 nozzle.json'},
                  {'name': 'Creality Ender-3 V3 0.6 nozzle', 'sub_path': 'machine/Creality Ender-3 V3 0.6 nozzle.json'},
                  ...
                  {'name': 'Creality Ender-5 0.4 nozzle', 'sub_path': 'machine/Creality Ender-5 0.4 nozzle.json'},
                  ...
                  {'name': 'Creality Ender-5 S1 0.4 nozzle', 'sub_path': 'machine/Creality Ender-5 S1 0.4 nozzle.json'},
                  {'name': 'Creality Ender-5S 0.4 nozzle', 'sub_path': 'machine/Creality Ender-5S 0.4 nozzle.json'},
                  {'name': 'Creality Ender-6 0.4 nozzle', 'sub_path': 'machine/Creality Ender-6 0.4 nozzle.json'},
                  {'name': 'Creality Hi 0.4 nozzle', 'sub_path': 'machine/Creality Hi 0.4 nozzle.json'},
                  {'name': 'Creality Hi 0.6 nozzle', 'sub_path': 'machine/Creality Hi 0.6 nozzle.json'},
                  {'name': 'Creality K1 (0.4 nozzle)', 'sub_path': 'machine/Creality K1 (0.4 nozzle).json'},
                  {'name': 'Creality K1 (0.6 nozzle)', 'sub_path': 'machine/Creality K1 (0.6 nozzle).json'},
                  {'name': 'Creality K1 (0.8 nozzle)', 'sub_path': 'machine/Creality K1 (0.8 nozzle).json'},
                  {'name': 'Creality K1 Max (0.4 nozzle)', 'sub_path': 'machine/Creality K1 Max (0.4 nozzle).json'},
                  {'name': 'Creality K1 Max (0.6 nozzle)', 'sub_path': 'machine/Creality K1 Max (0.6 nozzle).json'},
                  {'name': 'Creality K1 Max (0.8 nozzle)', 'sub_path': 'machine/Creality K1 Max (0.8 nozzle).json'},
                  {'name': 'Creality K1 SE 0.4 nozzle', 'sub_path': 'machine/Creality K1 SE 0.4 nozzle.json'},
                  {'name': 'Creality K1C 0.4 nozzle', 'sub_path': 'machine/Creality K1C 0.4 nozzle.json'},
                  {'name': 'Creality K1C 0.6 nozzle', 'sub_path': 'machine/Creality K1C 0.6 nozzle.json'},
                  {'name': 'Creality K1C 0.8 nozzle', 'sub_path': 'machine/Creality K1C 0.8 nozzle.json'},
                  {'name': 'Creality K2 Plus 0.2 nozzle', 'sub_path': 'machine/Creality K2 Plus 0.2 nozzle.json'},
                  {'name': 'Creality K2 Plus 0.4 nozzle', 'sub_path': 'machine/Creality K2 Plus 0.4 nozzle.json'},
                  {'name': 'Creality K2 Plus 0.6 nozzle', 'sub_path': 'machine/Creality K2 Plus 0.6 nozzle.json'},
                  {'name': 'Creality K2 Plus 0.8 nozzle', 'sub_path': 'machine/Creality K2 Plus 0.8 nozzle.json'},
                  {'name': 'Creality K2 Pro 0.2 nozzle', 'sub_path': 'machine/Creality K2 Pro 0.2 nozzle.json'},
                  {'name': 'Creality K2 Pro 0.4 nozzle', 'sub_path': 'machine/Creality K2 Pro 0.4 nozzle.json'},
                  {'name': 'Creality K2 Pro 0.6 nozzle', 'sub_path': 'machine/Creality K2 Pro 0.6 nozzle.json'},
                  {'name': 'Creality K2 Pro 0.8 nozzle', 'sub_path': 'machine/Creality K2 Pro 0.8 nozzle.json'},
                  {'name': 'Creality Sermoon V1 0.4 nozzle',
                   'sub_path': 'machine/Creality Sermoon V1 0.4 nozzle.json'}],
 'machine_model_list': [{'name': 'Creality CR-10 Max', 'sub_path': 'machine/Creality CR-10 Max.json'},
                        {'name': 'Creality CR-10 SE', 'sub_path': 'machine/Creality CR-10 SE.json'},
                        {'name': 'Creality CR-10 V2', 'sub_path': 'machine/Creality CR-10 V2.json'},
                        {'name': 'Creality CR-10 V3', 'sub_path': 'machine/Creality CR-10 V3.json'},
                        {'name': 'Creality CR-6 Max', 'sub_path': 'machine/Creality CR-6 Max.json'},
                        {'name': 'Creality CR-6 SE', 'sub_path': 'machine/Creality CR-6 SE.json'},
                        {'name': 'Creality CR-M4', 'sub_path': 'machine/Creality CR-M4.json'},
                        {'name': 'Creality Ender-3', 'sub_path': 'machine/Creality Ender-3.json'},
                        {'name': 'Creality Ender-3 Pro', 'sub_path': 'machine/Creality Ender-3 Pro.json'},
                        {'name': 'Creality Ender-3 S1', 'sub_path': 'machine/Creality Ender-3 S1.json'},
                        {'name': 'Creality Ender-3 S1 Plus', 'sub_path': 'machine/Creality Ender-3 S1 Plus.json'},
                        {'name': 'Creality Ender-3 S1 Pro', 'sub_path': 'machine/Creality Ender-3 S1 Pro.json'},
                        {'name': 'Creality Ender-3 V2', 'sub_path': 'machine/Creality Ender-3 V2.json'},
                        {'name': 'Creality Ender-3 V2 Neo', 'sub_path': 'machine/Creality Ender-3 V2 Neo.json'},
                        {'name': 'Creality Ender-3 V3', 'sub_path': 'machine/Creality Ender-3 V3.json'},
                        {'name': 'Creality Ender-3 V3 KE', 'sub_path': 'machine/Creality Ender-3 V3 KE.json'},
                        {'name': 'Creality Ender-3 V3 Plus', 'sub_path': 'machine/Creality Ender-3 V3 Plus.json'},
                        {'name': 'Creality Ender-3 V3 SE', 'sub_path': 'machine/Creality Ender-3 V3 SE.json'},
                        {'name': 'Creality Ender-5', 'sub_path': 'machine/Creality Ender-5.json'},
                        {'name': 'Creality Ender-5 Max', 'sub_path': 'machine/Creality Ender-5 Max.json'},
                        {'name': 'Creality Ender-5 Plus', 'sub_path': 'machine/Creality Ender-5 Plus.json'},
                        {'name': 'Creality Ender-5 Pro (2019)', 'sub_path': 'machine/Creality Ender-5 Pro (2019).json'},
                        {'name': 'Creality Ender-5 S1', 'sub_path': 'machine/Creality Ender-5 S1.json'},
                        {'name': 'Creality Ender-5S', 'sub_path': 'machine/Creality Ender-5S.json'},
                        {'name': 'Creality Ender-6', 'sub_path': 'machine/Creality Ender-6.json'},
                        {'name': 'Creality Hi', 'sub_path': 'machine/Creality Hi.json'},
                        {'name': 'Creality K1', 'sub_path': 'machine/Creality K1.json'},
                        {'name': 'Creality K1 Max', 'sub_path': 'machine/Creality K1 Max.json'},
                        {'name': 'Creality K1 SE', 'sub_path': 'machine/Creality K1 SE.json'},
                        {'name': 'Creality K1C', 'sub_path': 'machine/Creality K1C.json'},
                        {'name': 'Creality K2 Plus', 'sub_path': 'machine/Creality K2 Plus.json'},
                        {'name': 'Creality K2 Pro', 'sub_path': 'machine/Creality K2 Pro.json'},
                        {'name': 'Creality Sermoon V1', 'sub_path': 'machine/Creality Sermoon V1.json'}],
 'name': 'Creality',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  ...
                  {'name': '0.12mm Fine @Creality CR10Max', 'sub_path': 'process/0.12mm Fine @Creality CR10Max.json'},
                  ...
                  {'name': '0.12mm Fine @Creality Ender3V2', 'sub_path': 'process/0.12mm Fine @Creality Ender3V2.json'},
                  ...
                  {'name': '0.15mm Detail @Creality CR-M4', 'sub_path': 'process/0.15mm Detail @Creality CR-M4.json'},
                  ...
                  {'name': '0.24mm Draft @Creality CR10Max', 'sub_path': 'process/0.24mm Draft @Creality CR10Max.json'},
                  ...
                  {'name': '0.12mm Fine @Creality Hi', 'sub_path': 'process/0.12mm Fine @Creality Hi 0.4 nozzle.json'},
