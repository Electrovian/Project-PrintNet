...
# source: profiles/Co Print/machine/Co Print ChromaSet 0.4 nozzle - Ender-3 V3 Plus.json
DATA = {'change_filament_gcode': 'FILAMENT_CHANGE LAYER_NUM=[layer_num] NEXT_EXTRUDER=[next_extruder]',
 ...
 'printable_area': ['0x0', '290x0', '290x283', '0x283'],
