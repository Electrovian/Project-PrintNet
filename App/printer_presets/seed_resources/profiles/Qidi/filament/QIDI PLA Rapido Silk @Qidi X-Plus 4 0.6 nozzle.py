...
# source: profiles/Qidi/filament/QIDI PLA Rapido Silk @Qidi X-Plus 4 0.6 nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_id': 'QD_0_1_4',
 'filament_max_volumetric_speed': ['7.5'],
 'filament_settings_id': ['QIDI PLA Rapido Silk @Qidi X-Plus 4 0.6 nozzle'],
 'from': 'system',
