...
# source: profiles/Qidi/filament/Qidi PC-ABS-FR @Qidi X-Plus 4 0.6 nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'fan_max_speed': ['40'],
 'fan_min_speed': ['10'],
 'filament_id': 'QD_0_1_34',
 'filament_max_volumetric_speed': ['8'],
 'filament_settings_id': ['Qidi PC-ABS-FR @Qidi X-Plus 4 0.6 nozzle'],
 'from': 'system',
 'hot_plate_temp': ['100'],
