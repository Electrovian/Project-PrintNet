...
# source: profiles/OpenEYE/machine/OpenEYE Peacock V2 0.4 nozzle.json
DATA = {'adaptive_bed_mesh_margin': '10',
 ...
 'machine_start_gcode': 'SET_PRINT_STATS_INFO TOTAL_LAYER=[total_layer_count]\n'
                        'MMU_START_SETUP INITIAL_TOOL={initial_tool} TOTAL_TOOLCHANGES=!total_toolchanges! '
                        'REFERENCED_TOOLS=!referenced_tools! TOOL_COLORS=!colors! TOOL_TEMPS=!temperatures! '
                        'TOOL_MATERIALS=!materials! FILAMENT_NAMES=!filament_names! PURGE_VOLUMES=!purge_volumes!\n'
                        'MMU_START_CHECK\n'
                        'START_PRINT BED_TEMP=[bed_temperature_initial_layer] '
                        'EXTRUDER_TEMP=[nozzle_temperature_initial_layer] BED_TYPE="{curr_bed_type}" '
                        ...
                        'ADAPTIVE_MARGIN={adaptive_bed_mesh_margin}\n'
                        '; Enter YOUR exist start_print macro call here (minus purging logic because tool may not be '
                        'loaded yet)\n'
                        'MMU_START_LOAD_INITIAL_TOOL\n'
                        '; Optionally add YOUR additional start logic (like purging) here to run just prior to start\n'
                        'START_PRINT_SECONDARY\n'
                        'SET_PRINT_STATS_INFO TOTAL_LAYER={total_layer_count} ; For pause at layer functionality and '
                        'better print stats',
 'machine_unload_filament_time': '30',
 'name': 'OpenEYE Peacock V2 0.4 nozzle',
 'nozzle_diameter': ['0.4'],
 'printable_area': ['1.5x7', '235x7', '235x235', '1.5x235'],
 'printable_height': '200',
 'printer_model': 'OpenEYE Peacock V2',
 'printer_variant': '0.4',
 'retract_lift_below': ['180', '180'],
 'setting_id': 'GM001',
 'type': 'machine'}
