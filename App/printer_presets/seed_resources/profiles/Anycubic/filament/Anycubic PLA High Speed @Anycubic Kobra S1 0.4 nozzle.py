...
# source: profiles/Anycubic/filament/Anycubic PLA High Speed @Anycubic Kobra S1 0.4 nozzle.json
DATA = {'activate_air_filtration': ['1'],
 ...
 'filament_settings_id': ['Anycubic PLA High Speed @Anycubic Kobra S1 0.4 nozzle'],
 'filament_shrink': ['100%'],
 'filament_soluble': ['0'],
