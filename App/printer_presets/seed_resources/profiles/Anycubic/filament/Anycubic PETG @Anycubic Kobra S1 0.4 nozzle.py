...
# source: profiles/Anycubic/filament/Anycubic PETG @Anycubic Kobra S1 0.4 nozzle.json
DATA = {'activate_air_filtration': ['0'],
 ...
 'filament_settings_id': ['Anycubic PETG @Anycubic Kobra S1 0.4 nozzle'],
 'filament_shrink': ['100%'],
 'filament_soluble': ['0'],
 'filament_start_gcode': ['; filament start gcode'],
 'filament_toolchange_delay': ['0'],
 'filament_unload_time': ['24.75'],
