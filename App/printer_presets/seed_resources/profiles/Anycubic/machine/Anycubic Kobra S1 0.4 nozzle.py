...
# source: profiles/Anycubic/machine/Anycubic Kobra S1 0.4 nozzle.json
DATA = {'adaptive_bed_mesh_margin': '0',
 ...
 'machine_end_gcode': 'G92 E0\n'
                      'G1 E-2 F3000\n'
                      '{if max_layer_z < max_print_height-1}G1 Z{z_offset+min(max_layer_z+2, max_print_height)} F900 ; '
 ...
 'machine_start_gcode': 'G9111 bedTemp=[first_layer_bed_temperature] '
                        'extruderTemp=[first_layer_temperature[initial_tool]]\n'
                        'M117',
