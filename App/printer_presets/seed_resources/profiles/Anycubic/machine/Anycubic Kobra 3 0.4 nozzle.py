...
# source: profiles/Anycubic/machine/Anycubic Kobra 3 0.4 nozzle.json
DATA = {'adaptive_bed_mesh_margin': '0',
 'auxiliary_fan': '0',
 'bbl_use_printhost': '0',
 'bed_custom_model': '',
 'bed_custom_texture': '',
 'bed_exclude_area': ['0x0', '255x0', '255x255', '0x255', '0x0', '2x2', '2x253', '253x253', '253x2', '2x2'],
 'bed_mesh_max': '0,0',
 'bed_mesh_min': '0,0',
 ...
 'machine_end_gcode': 'M400\n'
                      ...
                      'G1 E-2 F3600\n'
                      '{if max_layer_z < max_print_height-1}G1 Z{max_layer_z+2} F900 ; Move print head further '
                      'up{endif}\n'
