...
# source: profiles/Anycubic/machine/Anycubic Kobra 2 Plus 0.4 nozzle.json
DATA = {'adaptive_bed_mesh_margin': '0',
 ...
 'machine_end_gcode': '{if max_layer_z < max_print_height}G1 Z{z_offset+min(max_layer_z+2, max_print_height)} F600 ; '
                      ...
                      '{if max_layer_z < max_print_height-10}G1 Z{z_offset+min(max_layer_z+70, max_print_height-10)} '
