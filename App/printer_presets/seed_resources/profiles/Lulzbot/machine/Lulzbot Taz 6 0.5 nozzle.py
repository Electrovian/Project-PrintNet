...
# source: profiles/Lulzbot/machine/Lulzbot Taz 6 0.5 nozzle.json
DATA = {'auxiliary_fan': '0',
 ...
 'machine_start_gcode': ";This G-Code has been translated from LulzBot's CuraLE (v4.13.10) startup GCODE for Taz 6 "
                        'Single Extruder by Wrathernaut\n'
                        ...
                        ';M206 X0 Y0 Z0; uncomment to adjust wipe position (+X ~ nozzle moves left)(+Y ~ nozzle moves '
                        'forward)(+Z ~ nozzle moves down)\n'
                        'G12; wiping sequence\n'
