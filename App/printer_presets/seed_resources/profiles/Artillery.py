...
# source: profiles/Artillery.json
DATA = {'description': 'Artillery configurations',
 'filament_list': [{'name': 'fdm_filament_common', 'sub_path': 'filament/fdm_filament_common.json'},
                   ...
                   {'name': 'Artillery Generic PLA', 'sub_path': 'filament/Artillery Generic PLA.json'},
                   {'name': 'Artillery Generic PLA-CF', 'sub_path': 'filament/Artillery Generic PLA-CF.json'},
                   {'name': 'Artillery Generic PETG', 'sub_path': 'filament/Artillery Generic PETG.json'},
                   {'name': 'Artillery Generic ABS', 'sub_path': 'filament/Artillery Generic ABS.json'},
                   {'name': 'Artillery Generic TPU', 'sub_path': 'filament/Artillery Generic TPU.json'},
                   {'name': 'Artillery Generic ASA', 'sub_path': 'filament/Artillery Generic ASA.json'},
                   {'name': 'Artillery PLA Basic', 'sub_path': 'filament/Artillery PLA Basic.json'},
                   {'name': 'Artillery PLA Matte', 'sub_path': 'filament/Artillery PLA Matte.json'},
                   {'name': 'Artillery PLA Silk', 'sub_path': 'filament/Artillery PLA Silk.json'},
                   {'name': 'Artillery PLA Tough', 'sub_path': 'filament/Artillery PLA Tough.json'},
                   {'name': 'Artillery PETG', 'sub_path': 'filament/Artillery PETG.json'},
                   {'name': 'Artillery TPU', 'sub_path': 'filament/Artillery TPU.json'},
                   {'name': 'Artillery ABS', 'sub_path': 'filament/Artillery ABS.json'},
                   ...
                   {'name': 'Artillery ABS @Artillery M1 Pro 0.8 nozzle',
                    'sub_path': 'filament/Artillery ABS @Artillery M1 Pro 0.8 nozzle.json'},
                   ...
                   {'name': 'Artillery ASA @Artillery M1 Pro 0.8 nozzle',
                    'sub_path': 'filament/Artillery ASA @Artillery M1 Pro 0.8 nozzle.json'},
                   ...
                   {'name': 'Artillery PET @Artillery M1 Pro 0.8 nozzle',
                    'sub_path': 'filament/Artillery PET @Artillery M1 Pro 0.8 nozzle.json'},
                   ...
                   {'name': 'Artillery TPU @Artillery M1 Pro 0.8 nozzle',
                    'sub_path': 'filament/Artillery TPU @Artillery M1 Pro 0.8 nozzle.json'}],
 'force_update': '0',
 'machine_list': [{'name': 'fdm_machine_common', 'sub_path': 'machine/fdm_machine_common.json'},
                  ...
                  {'name': 'Artillery Genius 0.4 nozzle', 'sub_path': 'machine/Artillery Genius 0.4 nozzle.json'},
                  ...
                  {'name': 'Artillery Hornet 0.4 nozzle', 'sub_path': 'machine/Artillery Hornet 0.4 nozzle.json'},
                  ...
                  {'name': 'Artillery M1 Pro 0.2 nozzle', 'sub_path': 'machine/Artillery M1 Pro 0.2 nozzle.json'},
                  {'name': 'Artillery M1 Pro 0.4 nozzle', 'sub_path': 'machine/Artillery M1 Pro 0.4 nozzle.json'},
                  {'name': 'Artillery M1 Pro 0.6 nozzle', 'sub_path': 'machine/Artillery M1 Pro 0.6 nozzle.json'},
                  {'name': 'Artillery M1 Pro 0.8 nozzle', 'sub_path': 'machine/Artillery M1 Pro 0.8 nozzle.json'}],
 'machine_model_list': [{'name': 'Artillery Sidewinder X1', 'sub_path': 'machine/Artillery Sidewinder X1.json'},
                        {'name': 'Artillery Genius', 'sub_path': 'machine/Artillery Genius.json'},
                        {'name': 'Artillery Genius Pro', 'sub_path': 'machine/Artillery Genius Pro.json'},
                        {'name': 'Artillery Sidewinder X2', 'sub_path': 'machine/Artillery Sidewinder X2.json'},
                        {'name': 'Artillery Hornet', 'sub_path': 'machine/Artillery Hornet.json'},
                        {'name': 'Artillery Sidewinder X3 Pro', 'sub_path': 'machine/Artillery Sidewinder X3 Pro.json'},
                        {'name': 'Artillery Sidewinder X3 Plus',
                         'sub_path': 'machine/Artillery Sidewinder X3 Plus.json'},
                        {'name': 'Artillery Sidewinder X4 Pro', 'sub_path': 'machine/Artillery Sidewinder X4 Pro.json'},
                        {'name': 'Artillery Sidewinder X4 Plus',
                         'sub_path': 'machine/Artillery Sidewinder X4 Plus.json'},
                        {'name': 'Artillery M1 Pro', 'sub_path': 'machine/Artillery M1 Pro.json'}],
 'name': 'Artillery',
 'process_list': [{'name': 'fdm_process_common', 'sub_path': 'process/fdm_process_common.json'},
                  {'name': '0.16mm Optimal @Artillery X1', 'sub_path': 'process/0.16mm Optimal @Artillery X1.json'},
                  ...
                  {'name': '0.20mm Standard @Artillery X1', 'sub_path': 'process/0.20mm Standard @Artillery X1.json'},
                  ...
                  {'name': '0.20mm Standard @Artillery X2', 'sub_path': 'process/0.20mm Standard @Artillery X2.json'},
                  {'name': '0.20mm Standard @Artillery Hornet',
                   'sub_path': 'process/0.20mm Standard @Artillery Hornet.json'},
                  {'name': '0.24mm Draft @Artillery X1', 'sub_path': 'process/0.24mm Draft @Artillery X1.json'},
                  {'name': '0.25mm Draft @Artillery Genius', 'sub_path': 'process/0.25mm Draft @Artillery Genius.json'},
                  {'name': '0.25mm Draft @Artillery Genius Pro',
                   'sub_path': 'process/0.25mm Draft @Artillery Genius Pro.json'},
                  {'name': '0.24mm Draft @Artillery Hornet', 'sub_path': 'process/0.24mm Draft @Artillery Hornet.json'},
