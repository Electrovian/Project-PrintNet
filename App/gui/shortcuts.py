...
SHORTCUTS = [
    ...
    ShortcutDef("prepare_add_model", "Add model", "Ctrl+I", "Prepare"),
    ShortcutDef("prepare_add_plate", "Add plate", "Ctrl+Shift+I", "Prepare"),
    ...
    ShortcutDef("prepare_add_instance", "Add instance", "+", "Prepare"),
    ShortcutDef("prepare_remove_instance", "Remove instance", "-", "Prepare"),
    ShortcutDef("prepare_split_objects", "Split to objects", "Ctrl+Shift+O", "Prepare"),
    ShortcutDef("prepare_split_parts", "Split to parts", "Ctrl+Shift+P", "Prepare"),
    ShortcutDef("prepare_variable_layer", "Variable layer height", "V", "Prepare"),
    ShortcutDef("prepare_mesh_boolean", "Mesh Boolean", "B", "Prepare"),
    ShortcutDef(
        "prepare_auto_orient",
    ...
    ShortcutDef("prepare_gizmo_fuzzy", "Gizmo paint-on fuzzy skin", "H", "Prepare"),
    ShortcutDef("prepare_gizmo_text", "Gizmo Text emboss / engrave", "T", "Prepare"),
    ShortcutDef("prepare_gizmo_measure", "Measure", "U", "Prepare"),
    ShortcutDef("prepare_gizmo_assembly", "Assembly View", "Y", "Prepare"),
    ShortcutDef("prepare_gizmo_brim_ears", "Brim Ears", "E", "Prepare"),
